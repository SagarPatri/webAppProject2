	...
	<div class="contentArea" id="contentArea">
		...
		<fieldset>
			...
			<table align="center" class="formContainer" border="0" cellspacing="0" cellpadding="0" >
				...
				<tr>
					<td width="23%" height="20" class="formLabel">Normal Corpus Buffer Amt (Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.norCorpusBufAmt"/>
					</td>
					<td width="23%"  height="20" class="formLabel">Utilized Normal Corpus Buffer Amt (Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.utilizedBufferAmt"/>
					</td>
				</tr>
				<tr>
					<td width="23%"  height="20" class="formLabel">Normal Medical Buffer Amt(Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.norMedicalBufAmt"/>
					</td>
					<td width="23%"  height="20" class="formLabel">Utilized Normal Medical Buffer Amt (Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.utilizedNorMedicalBufAmt"/>
					</td>
				</tr>
				<tr>
					<td width="23%"  height="20" class="formLabel">Critical Corpus Buffer Amt (Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.criCorpusBufAmt"/>
					</td>
					<td width="23%"  height="20" class="formLabel">Utilized Critical Corpus Buffer Amt (Rs):</td>
					<td width="27%"  class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.utilizedCriCorpusBufAmt"/>
					</td>
					</tr>
					  <tr>
					<td width="23%"  height="20" class="formLabel">Critical Medical Buffer Amt (Rs):</td>
					<td width="27%"  class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.criMedicalBufAmt"/>
					</td>
					<td width="23%"  height="20" class="formLabel">Utilized Critical Medical Buffer Amt (Rs):</td>
					<td width="27%"  class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.utilizedCriMedicalBufAmt"/>
					</td>
				</tr>
				<!-- set5-->
				 <tr>
					<td height="20" class="formLabel">CriticalIllness Buffer Amt (Rs):</td>
					<td class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.criIllnessBufAmt"/>
					</td>
					<td height="20" class="formLabel">Utilized CriticalIllness Buffer  Amt (Rs):</td>
					<td class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.utilizedCriIllnessBufAmt"/>
					</td>
				</tr>
				<tr>
				...
				<%-- <tr>
                   <td height="20" class="formLabel">Buffer Family/Member Cap (Rs):</td>
					...
					<!-- Added Policy Deductable KOC-1277-->
				<tr>
					<td height="20" class="formLabel">High Deductable Amt(Rs):</td>
					<td class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.policyDeductableAmt"/>
					</td>	
					
					<td height="20" class="formLabel">Utilized High Deductable Amt(Rs):</td>
					<td class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="balanceSIInfoVO.utilizedPolicyDedAmt"/>
					</td>	
				</tr>			
			</table>
		</fieldset>
		...
		<logic:equal name="frmSIAuthorizationDetails" property="memberBufferVO.memberBufferYN" value="Y">
		   <fieldset>
			...
			<table align="center" class="formContainer" border="0" cellspacing="0" cellpadding="0" >
				...
				<tr>
					<td height="20" class="formLabel">Member/Family Normal Corpus Buffer Amt. (Rs):</td>
					<td class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.bufferAmtMember"/>
					</td>
					<td height="20" class="formLabel">Utilized Member/Family Normal Corpus Buffer Amt. (Rs):</td>
					<td class="formLabelBold">
			...
			<tr>
					<td width="23%"  height="20" class="formLabel">Member/Family Normal Medical Family/Member Cap (Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.norMedicalBufAmt"/>
					</td>
					<td width="23%"  height="20" class="formLabel">Utilized Member/Family Normal Medical Buffer Amt (Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.utilizedNorMedicalBufAmt"/>
					</td>
				</tr>
			...
			<legend>Critical Buffer Details</legend>
			  <table align="center" class="formContainer" border="0" cellspacing="0" cellpadding="0" >
				...
				<tr>
					<td width="23%"  height="20" class="formLabel">Member/Family Critical Corpus Buffer Family/Member Cap (Rs):</td>
					<td width="27%" class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.criCorpusBufAmt"/>
					</td>
					<td width="23%"  height="20" class="formLabel">Utilized Member/Family Critical Corpus Buffer Amt (Rs):</td>
					<td width="27%"  class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.utilizedCriCorpusBufAmt"/>
					</td>
					</tr>
					<!-- set4 -->
				  
			    <tr>
					<td width="23%"  height="20" class="formLabel">Member/Family Critical Medical Cap (Rs):</td>
					<td width="27%"  class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.criMedicalBufAmt"/>
					</td>
					<td width="23%"  height="20" class="formLabel">Utilized Member/Family Critical Medical Buffer Amt (Rs):</td>
					<td width="27%"  class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.utilizedCriMedicalBufAmt"/>
					</td>
				</tr>
				
				 <tr>
					<td height="20" class="formLabel">Member/Family CriticalIllness Buffer  Cap (Rs):</td>
					<td class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.criIllnessBufAmt"/>
					</td>
					<td height="20" class="formLabel">Utilized Member/Family CriticalIllness Buffer  Amt (Rs):</td>
					<td class="formLabelBold">
						<bean:write name="frmSIAuthorizationDetails" property="memberBufferVO.utilizedCriIllnessBufAmt"/>
					</td>
				</tr>
				</table>
				</fieldset>
