...
public class TariffUploadErrorLogTable extends Table
{
	/**
	...
	public void setTableProperties()
    {
        ...
        Column colTarifftype=new Column("Tariff Type");
        colTarifftype.setMethodName("getTariffTypeDesc");
        colTarifftype.setColumnWidth("20%");
        colTarifftype.setIsHeaderLink(true);
        colTarifftype.setDBColumnName("FILE_NAME");
        addColumn(colTarifftype);
