...
function edit3(rownum)
{
 ...
 document.forms[1].rownum.value=rownum;
 document.forms[1].action = "/OnlinePreAuthProceedAction.do?fromFlag=preAuth"+"&refview="+"refview";
 JS_SecondSubmit=true;
 document.forms[1].submit();
}
} 
...
function onAppealButton(rownum)
{
	if(!JS_SecondSubmit)
	{
		 document.forms[1].mode.value ="doView";
		 document.forms[1].rownum.value=rownum;
		 document.forms[1].action = "/OnlinePreAuthProceedAction.do?fromFlag=preAuth"+"&appealBtn="+"appealBtn";
		 JS_SecondSubmit=true;
		 document.forms[1].submit();
	} 
}