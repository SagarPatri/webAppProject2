...
public class PartnerFeedbackAction extends TTKAction
{
    private static Logger log = Logger.getLogger( PartnerFeedbackAction.class ); 
    ...
    private static final String strPtnrFeedbackError="feedback";
    
    
    private static final String strPartnerStatus="feedbacks";
    ...
    public ActionForward doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		log.debug("Inside the doDefault method of PartnerFeedbackAction");
    		setLinks(request);
    		...
    		statusVO=hospitalObject.getPartnerStatus(TTKCommon.getWebBoardId(request));
    		//set the form bean
		...
		{
			return this.processExceptions(request, mapping, new TTKException(exp,strPtnrFeedbackError));
    ...
    public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		setLinks(request);
    		log.debug("Inside the doSearch method of PartnerFeedbackAction");
    		HospitalManager hospitalObject=this.getHospitalManagerObject();
    		TableData tableData=TTKCommon.getTableData(request);
            ...
            else
            {
                ...
                tableData.setSearchData(this.populateSearchCriteria((DynaActionForm)form,lPartnerSeqId));
                tableData.modifySearchData("search");
            }//end of else
            ArrayList alFeedback= hospitalObject.getPartnerFeedbackList(tableData.getSearchData());
    ...
    public ActionForward doChangeWebBoard(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    		HttpServletResponse response) throws Exception{
    	log.debug("Inside the doChangeWebBoard method of PartnerFeedbackAction");
    ...
    public ActionForward doAdd(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		setLinks(request);
    		log.debug("Inside the doAdd method of PartnerFeedbackAction");
    		HospitalManager hospitalObject=this.getHospitalManagerObject();
    		StringBuffer sbfCaption= new StringBuffer();
            sbfCaption.append("Feedback Details -");
    		DynaActionForm hospitalFeedbackForm = (DynaActionForm)form;
            ArrayList alFeedbackList= hospitalObject.getQAPartnerList();
    ...
    public ActionForward doView(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		setLinks(request);
    		log.debug("Inside the doView method of PartnerFeedbackAction");
    		HospitalManager hospitalObject=this.getHospitalManagerObject();
    		StringBuffer sbfCaption= new StringBuffer();
            sbfCaption.append("Feedback Details -");
    		DynaActionForm hospitalFeedbackForm = (DynaActionForm)form;
    ...
    public ActionForward doSave(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		setLinks(request);
    		log.debug("Inside the doSave method of PartnerFeedbackAction");
    		HospitalManager hospitalObject=this.getHospitalManagerObject();
    		StringBuffer sbfCaption= new StringBuffer();
    		sbfCaption.append("Feedback Details -");
    		DynaActionForm hospitalFeedbackForm = (DynaActionForm)form;
    				...
    				&& (String)hospitalFeedbackForm.get("feedBackSeqId")!="")
    		{
    			...
    			feedbackVO.setFeedbackSeqId(lFeedBackSeqId);
    		          ...
    		          //&& (String)hospitalFeedbackForm.get("feedBackSeqId")!="")
    		feedbackVO.setPtnrSeqId(lPartnerSeqId);
    		...
    		Long lngCount=hospitalObject.addUpdatePartnerFeedback(feedbackVO);
    		if(lngCount>0)
    		{
    		...
    		alFeedback=(ArrayList)hospitalObject.getPartnerFeedback(lngCount);
    ...
    public ActionForward doClose(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		setLinks(request);
    		log.debug("Inside the doClose method of PartnerFeedbackAction");
    		TableData tableData=TTKCommon.getTableData(request);
    		HospitalManager hospitalObject=this.getHospitalManagerObject();
    ...
    public ActionForward doDeleteList(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		setLinks(request);
    		log.debug("Inside the doDeleteList method of PartnerFeedbackAction");
    		HospitalManager hospitalObject=this.getHospitalManagerObject();
    		TableData tableData=TTKCommon.getTableData(request);
    		...
    		int iCount = hospitalObject.deletePartnerFeedback(sbfDeleteId.append("|").toString());
    		//refresh the grid with search data in session
    		ArrayList alFeedback = null;//hospitalObject.getPartnerFeedbackList(tableData.getSearchData());
    		...
    		if(iCount == tableData.getData().size())
    		{
    			...
    			if(iStartRowCount > 0)
    			{
    				alFeedback = hospitalObject.getPartnerFeedbackList(tableData.getSearchData());
    ...
    public ActionForward doDelete(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		setLinks(request);
    		log.debug("Inside the doDelete method of PartnerFeedbackAction");
    		HospitalManager hospitalObject=this.getHospitalManagerObject();
    		TableData tableData=TTKCommon.getTableData(request);
    		DynaActionForm hospitalFeedbackForm = (DynaActionForm)form;
    		StringBuffer sbfDeleteId = new StringBuffer("|");
     ...
     * @param lPartnerSeqId which will have long value
     * @return alSearchParams ArrayList
     */
    private ArrayList<Object> populateSearchCriteria(DynaActionForm searchFeedbackForm,Long lPartnerSeqId)
    {
    ...
    }//end of populateSearchCriteria(DynaActionForm searchFeedbackForm,HttpServletRequest request,Long lPartnerSeqId)
    ...
    private HospitalManager getHospitalManagerObject() throws TTKException
    {
        ...
        {
            throw new TTKException(exp, strPtnrFeedbackError);
        }//end of catch
    ...
    public ActionForward doSaveStatus(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception{
    	try{
			...
			int result=hospitalObject.updatePartnerStatus(statusVO);
