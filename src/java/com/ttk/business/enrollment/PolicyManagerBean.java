...
import com.ttk.dao.impl.enrollment.PolicyDAOImpl;
...
public class PolicyManagerBean implements PolicyManager{
	...
	public ArrayList getGroupListFinance(ArrayList alSearchCriteria) throws TTKException {
		policyDAO = (PolicyDAOImpl)this.getEnrollmentDAO("enrollment");
		return policyDAO.getGroupListFinance(alSearchCriteria);
	}//end of getGroupList(ArrayList alSearchCriteria)
    ...
    public long savePolicy(PolicyDetailVO policyDetailVO,String strPolicyMode,String strPolicyType,byte[]data) throws TTKException {
		policyDAO = (PolicyDAOImpl)this.getEnrollmentDAO("enrollment");
		return policyDAO.savePolicy(policyDetailVO,strPolicyMode,strPolicyType,data);
	...
	public ArrayList<Object> getInsCode(String InsName) throws TTKException
	{
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.getInsCode(InsName);
	}//end of getInsCode(String InsName)
	//test nag
	...
	{
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.savePolicyDocsUploads(alFileAUploadList,userSeqId, policy_seq_id, origFileName, inputStream, formFileSize);
	}//end of getInsCode(String InsName)
	public ArrayList getPolicyDocsUploads(String policy_seq_id) throws TTKException
	{
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.getPolicyDocsUploads(policy_seq_id);
	}//end of getPolicyDocsUploads(String InsName)

	@Override
	public Long addPremiumDetails(PolicyDetailVO policyDetailVO) throws TTKException {
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.addPremiumDetails(policyDetailVO);
	}

	@Override
	public ArrayList<String[]> getPremiumDetails(Long lngPremiumSeqId, Long policyid) throws TTKException {
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.getPremiumDetails(lngPremiumSeqId,policyid);
	}

	@Override
	public ArrayList<String[]> selectPremiumDetails(Long lngPremiumSeqId,Long policyid) throws TTKException {
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.selectPremiumDetails(lngPremiumSeqId,policyid);
	}
