...
public class CashlessVO extends BaseVO{
    ...
    private Long lngDiagGenSeqId	=	null;	
    private String strTestName= "";
    
    
    private BigDecimal bdTotalEnteredRate	=	null;
	private BigDecimal bdTotalAgreedRate	=	null;
	private BigDecimal bdTotalDiscPerc		=	null;
	private BigDecimal bdTotalDiscRate		=	null;
	private BigDecimal bdRejectedAmount		=	null;
	private Integer intMemberSeqId 			= 	null;
	private String strTpaEnrolID			=	"";
	private String strAuthNumb				=	"";
	private String strPreAuthStatus			=	"";
	private String strDcRemarks				=	"";
	private String strRefNo					=	"";
    private String lngTotRate				=	null;
    
    public String getTotRate() {
		return lngTotRate;
	}
	public void setTotRate(String lngTotRate) {
		this.lngTotRate = lngTotRate;
	}
	public String getRefNo() {
		return strRefNo;
	}
	public void setRefNo(String strRefNo) {
	...
	public void setDcRemarks(String strDcRemarks) {
		this.strDcRemarks = strDcRemarks;
	}
	
	public String getAuthNumb() {
		return strAuthNumb;
	}
	
	public void setAuthNumb(String strAuthNumb) {
		this.strAuthNumb = strAuthNumb;
	}
	
	public String getPreAuthStatus() {
		return strPreAuthStatus;
	}
	
	public void setPreAuthStatus(String strPreAuthStatus) {
		this.strPreAuthStatus = strPreAuthStatus;
	}
	
	public BigDecimal getRejectedAmount() {
		return bdRejectedAmount;
	}

	public void setRejectedAmount(BigDecimal bdRejectedAmount) {
		this.bdRejectedAmount = bdRejectedAmount;
	}
	
	public BigDecimal getTotalEnteredRate() {
		return bdTotalEnteredRate;
	}

	public void setTotalEnteredRate(BigDecimal bdTotalEnteredRate) {
		this.bdTotalEnteredRate = bdTotalEnteredRate;
	}

	public BigDecimal getTotalAgreedRate() {
		return bdTotalAgreedRate;
	}

	public void setTotalAgreedRate(BigDecimal bdTotalAgreedRate) {
		this.bdTotalAgreedRate = bdTotalAgreedRate;
	}

	public BigDecimal getTotalDiscPerc() {
		return bdTotalDiscPerc;
	}

	public void setTotalDiscPerc(BigDecimal bdTotalDiscPerc) {
		this.bdTotalDiscPerc = bdTotalDiscPerc;
	}

	public BigDecimal getTotalDiscRate() {
		return bdTotalDiscRate;
	}

	public void setTotalDiscRate(BigDecimal bdTotalDiscRate) {
		this.bdTotalDiscRate = bdTotalDiscRate;
	}
	
	public String getTpaEnrolID() {
		return strTpaEnrolID;
	}
	
	public void setTpaEnrolID(String strTpaEnrolID) {
		this.strTpaEnrolID = strTpaEnrolID;
	}
	
   public Integer getMemberSeqId() {
       return intMemberSeqId;
   }//end of getMemberSeqId()
   
   public void setMemberSeqId(Integer intMemberSeqId) {
       this.intMemberSeqId = intMemberSeqId;
   }//end of setMemberSeqId(Integer intMemberSeqId)
   
    
    /** Retrieve the Diagnosis Seq ID
	 * @return Returns the lngDiagGenSeqId.
	 */
	public Long getDiagGenSeqId() {
		return lngDiagGenSeqId;
	}//end of getDiagGenSeqId()

	/** Sets the Assign User Seq ID
	 * @param lngDiagGenSeqId The lngDiagGenSeqId to set.
	 */
	public void setDiagGenSeqId(Long lngDiagGenSeqId) {
		this.lngDiagGenSeqId = lngDiagGenSeqId;
	}//end of setDiagGenSeqId(Long lngDiagGenSeqId)
