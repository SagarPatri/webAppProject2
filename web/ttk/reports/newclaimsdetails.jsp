				...
				<logic:notMatch name="frmReportList" property="selectRptType" value="CAC">
					<tr>
						...
						<td>
						   ...
						   <td colspan="3">
         					<html:select property="corporatename" styleId="select" styleClass="selectBox selectBoxMedium" onchange="javascript:onReportType()" >
					...
					<tr>
					  <td class="formLabel">Provider Name </td>
						   <td colspan="3">
         					<html:select property="providername" styleId="select" styleClass="selectBox selectBoxMedium" onchange="javascript:onReportType()" >
