...
<html:form action="/UploadPolicyDocs.do"  method="post" enctype="multipart/form-data">
	...
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
		<tr>
    		<td>Policy Documents Uploads- <bean:write name="frmPolicyUploads" property="caption"/></td>   
    		</tr>
	</table>
	<html:errors/>
	<!-- E N D : Page Title --> 
	...
	<fieldset>
		...
		<table class="formContainer" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
			...
			<tr style="border:1px solid;">
          		...
          		<td width="19%" align="left" nowrap>&nbsp;&nbsp;Type:<span class="mandatorySymbol">*</span></td>
          		<td width="18%" align="left" nowrap>
          			<html:select property ="description" name="frmPolicyUploads" styleClass="selectBox selectBoxMedium" disabled="<%=viewmode%>">
       					<html:option value="">--Select from list--</html:option>
              			<html:option value="SCP">Scanned Copy</html:option>
              			<html:option value="PFM">Proposal Form</html:option>
          			</html:select>
          		</td>
