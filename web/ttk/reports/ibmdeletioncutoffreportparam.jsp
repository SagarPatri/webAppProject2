<%
/** @ (#) IBMAdditioncutoffreportparam.jsp
 * Project     : TTK Healthcare Services
 * File        : IBMAdditioncutoffreportparam.jsp
 * Author      : Balaji C R B
...
<script language="javascript" src="/ttk/scripts/reports/ibmdeletioncutoffreportparam.js"></script>
<script language="javascript" src="/ttk/scripts/calendar/calendar.js"></script>
<html:form action="/IBMReportsAction.do">
	<!-- S T A R T : Page Title -->
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>Corporate Report - DeletionCutOff</td>
		</tr>
	</table>
	<!-- E N D : Page Title -->
		...
		<legend>Report Parameters </legend>
			<table border="0" align="center" cellpadding="0" cellspacing="0" class="formContainer">
				<tr>
					...
					<!-- <td nowrap>IBM SeqNo. <span class="mandatorySymbol">*</span></td> -->
					<td>
					<html:hidden name="frmReportList" property="IBMPolicyNo" />
						...
						<!--<html:text name="frmReportList" property="IBMPolicyNo"  styleClass="textBox textBoxSmall" maxlength="10" disabled="true"/> -->	
		    			<!--</html:select>-->
					</td> 
				</tr>
				<tr>
	...
	<table align="center" class="buttonsContainer" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100%" align="center">Report Type
				...
				<button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'"	onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGenerateIbmDeletionCutOffReport();"><u>G</u>enerateReport</button>
				&nbsp;
