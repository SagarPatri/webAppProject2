...
<!-- <div id="navigateBar">Home &gt; Dashboard</div> -->
  ...
  <li class="pusher"></li>
	<li>
      <div>
        <img src="/ttk/images/Insurance/big_hexagon.png" title="">
  ...
  <li>
      <div>
	  <img src="/ttk/images/Insurance/big_hexagon.png" title=""/><br>
...
<p style="margin-bottom:0px;margin-left:12%;margin-top: -4%;"><img class="hexagon_small" src="/ttk/images/Insurance/small_hexagon_1.png" title="" align="middle"> &nbsp;&nbsp;&nbsp;
