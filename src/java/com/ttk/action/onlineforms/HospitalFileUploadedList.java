...
public class HospitalFileUploadedList extends TTKAction {

	private  Logger log = Logger.getLogger( HospitalFileUploadedList.class ); // Getting Logger for this Class file
