...
public class PreAuthTariffAction extends TTKAction{
	...
	public ActionForward doCalculate(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			...
			String[] strImmuneTypeID = request.getParameterValues("immuneTypeID");//added for KOC 1315
			String[] strWellchildTypeID = request.getParameterValues("wellchildTypeID");//added for KOC 1316
			String[] strRoutadultTypeID = request.getParameterValues("routadultTypeID");//added for KOC 1308
			String[] strCaptureNbrOfDaysYN = request.getParameterValues("captureNbrOfDaysYN");
			String[] strWardTypeID = request.getParameterValues("wardTypeID");
			...
			if(lngSelectedTariffSeqID !=null && lngSelectedTariffSeqID.length>0)
			{
				for(int i=0;i<lngSelectedTariffSeqID.length;i++)
				{
					...
					tariffDetailVO.setImmuneTypeID(strImmuneTypeID[i]);//added for koc 1315
					tariffDetailVO.setWellchildTypeID(strWellchildTypeID[i]);//added for koc 1316
					tariffDetailVO.setRoutadultTypeID(strRoutadultTypeID[i]);//added for koc 1308
