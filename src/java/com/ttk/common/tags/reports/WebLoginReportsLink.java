...
public class WebLoginReportsLink extends TagSupport{
...
//	private static Logger log = Logger.getLogger(WebLoginReportsLink.class );
	public int doStartTag() throws JspException
	{
		try
		{
			...
			System.out.print("strActiveSubLink>>"+strActiveSubLink);
			...
			if(reportTypeList!=null)
			{
				...
				while(itReportType.hasNext())
				{
					...
					if(reportsList!=null)
					{
						...
						out.println("<table align=\"center\" class=\"formContainerWeblogin\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
							out.println("<tr><td><ul  class=\"bulletListing\">");
							while(itReports.hasNext())
							{
								...
								{
									out.println("<li class=\"bulletListing li\"><a href=\"#\" onClick=\"javascript:onSelectLink('"+eleReport.valueOf("@pdfxml")+"','"+eleReport.valueOf("@xlsxml")+"','"+eleReport.valueOf("@csvxml")+"','"+eleReport.valueOf("@id")+"','"+eleReport.valueOf("@name")+"')\">"+eleReport.valueOf("@name")+"</a></li>");//KOC 1353 for payment report
