...
function onSelectGroup()
{
	...
	document.forms[1].reportID.value="IBMGrpPreAuthRpt";
	document.forms[1].action="/IBMReportsAction.do";
	document.forms[1].submit();
...
function onSelectPolicy()
{
	if(document.forms[1].policySeqID.value!=""){
		document.forms[1].mode.value="doIBMPreauthSelectPolicy";
		document.forms[1].action="/IBMReportsAction.do";
		document.forms[1].submit();
...
function onGeneratePreauthReport()
{
	...
	var preaauthStatus = document.forms[1].policyPreauthID.value;
   ...
   /* if(document.forms[1].policySeqID.value=="")
	...
	//var partmeter = "?mode=doGeneratePreauthReport&parameter="+parameterValue+"&parameter1="+parameterValue1+"&fileName=reports/enrollment/AccentureReport.jrxml&reportID=IBMGrpPreAuthRpt&reportID1=IBMClaimRpt&reportType="+reportType
					//+"&sFrom="+reportFrom+"&sTo="+reportTo;
    
    var partmeter = "?mode=doGeneratePreauthReport&Polgrpseqid="+policySeqID+"&reportID=IBMGrpPreAuthRpt&reportID1=IBMClaimRpt&reportType="+reportType+"&sFrom="+reportFrom+"&sTo="+reportTo+"&status="+preaauthStatus;
	...
	document.forms[1].mode.value="doGeneratePreauthReport";
	window.open(openPage,'',features);
	//document.forms[1].submit();
}//end of onGeneratePreauthReport
