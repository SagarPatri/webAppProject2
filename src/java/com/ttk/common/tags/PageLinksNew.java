...
/**
 * @ (#) PageLinksNew.java Aug 8, 2005
 * Project      :
 * File         : PageLinksNew.java
 ...
 *  to generate the HTML Page Links
 */
public class PageLinksNew extends TagSupport {
	...
	*/
    ...
    private static Logger log = Logger.getLogger( PageLinksNew.class );
    String strName = "";
    String strScope = "";
    ...
    public int doStartTag() throws JspException {
		try
		{
			...
			{
				pageContext.getOut().print("&nbsp;<a href=\"#\" onClick=\"javascript:PressBackWardNew()\"><img src=\"/ttk/images/Prev.gif\" alt=\"Previous Page\" width=\"4\" height=\"8\" border=\"0\"></a>&nbsp;&nbsp;");
			...
			for(int i=0;i<iPageLinks.length;i++)
			{
				...
				{
					pageContext.getOut().print("<a href=\"#\" onClick=\"javascript:pageIndexNew("+iPageLinks[i]+")\" title=\"Page "+(iAddPageNum + iPageLinks[i])+"\">"+ (iAddPageNum + iPageLinks[i]) +"</a>");
					pageContext.getOut().print("&nbsp;");
			...
			{
				pageContext.getOut().print("&nbsp;&nbsp;<a href=\"#\" onClick=\"javascript:PressForwardNew()\"><img src=\"/ttk/images/Next.gif\" alt=\"Next Page\" width=\"4\" height=\"8\" border=\"0\"></a>");
			...
			throw new JspException("Error: IOException in PageLinksNew !!!!!" + ioe.getMessage());
		}
		catch(Exception exp)
		{
			exp.printStackTrace();
			log.debug("error occured in PageLinksNew !!!!! ");
		}//end of catch block
		return SKIP_BODY;
	}//end of doStartTag()
