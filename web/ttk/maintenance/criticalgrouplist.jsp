<%
/** @ (#) daycaregrouplist.jsp 22nd Oct 2007
...
<script language="javascript" src="/ttk/scripts/maintenance/criticalgrouplist.js"></script>
<!-- S T A R T : Content/Form Area -->
<html:form action="/CriticalGroupsAction.do" >
	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<a href="#" accesskey="s" onClick="javascript:onCriticalSearch()"   class="search"><img src="/ttk/images/SearchIcon.gif" title="Search" alt="Search" width="16" height="16" border="0" align="absmiddle">&nbsp;<u>S</u>earch</a></td>
        <td width="100%">&nbsp;</td>
      </tr>
     </table>
	<!-- E N D : Search Box -->
