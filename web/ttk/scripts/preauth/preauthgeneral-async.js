...
function getcurrencyCode(){
	 ...
	 alert("Requested Amount Currency will Change");
	 var countryId= document.getElementById("providerCountry").value;
	...
	$.ajax({
        ...
        success : function(data){
              ...
              if(rstatus==="EO"||rstatus.length==2){
            	  if(document.getElementById('icdResult1') != null){
              	document.getElementById('icdResult1').style.color='red';
              	...
              	var mat_icd_yn = dataArray[4];
              	if(document.getElementById("primary_id")){
              		document.getElementById("primary_id").value=primary;
              	}
              	if(document.getElementById("mat_icd_yn_id")){
              		document.getElementById("mat_icd_yn_id").value=mat_icd_yn;
              	}
