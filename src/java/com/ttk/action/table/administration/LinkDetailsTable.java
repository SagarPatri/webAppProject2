...
public class LinkDetailsTable extends Table
{
    ...
    public void setTableProperties()
    {
        ...
        colLinkDescription.setColumnWidth("30%");
        ...
        Column colOrderNumber = new Column("Sort Order");
        colOrderNumber.setMethodName("getOrderNumber");
        colOrderNumber.setColumnWidth("30%");
