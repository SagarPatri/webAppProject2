...
public class PolicyRelatedInformation  extends TagSupport
{
	/**
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			*/
			...
			{
				out.print("<select id='productSeqID' name=\"productSeqID\" CLASS=\"selectBox selectBoxLargest\""+strViewmode+" onchange='getNetworkType()'>");
				out.print("<option value=\"\">Select from list</option>");
