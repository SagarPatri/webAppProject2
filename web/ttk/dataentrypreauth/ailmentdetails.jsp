...
<script language="javascript" src="/ttk/scripts/dataentrypreauth/ailmentdetails.js"></script>
  ...
  <html:errors/>
    ...
    <table width="98%" align="center"  border="0" cellspacing="0" cellpadding="0">
	  	<tr>
			  ...
			  <logic:match name="frmAilmentDetails" property="medCompleteYN" value="Y">
...
<legend>Medical Information</legend>
  	<table align="center" class="formContainer" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
      		...
      		<td>
		      	<html:select property="medicineSystemTypeID" name="frmAilmentDetails" styleClass="selectBox" disabled="<%= viewmode %>">
...
<logic:match name="frmAilmentDetails" property="specialityTypeID" value="MAS" >
   <tr id="maternitytype" style="display: ">
	...
	<tr id="noofbiological" style="display: ">
        ...
        <logic:match name="strLink" value="Claims" >
        <tr>
          <td class="formLabel">Final Diagnosis:</td>
            <td class="formLabel">
        ...
        <!-- logic condition removed for Decoupling -->        
        <tr>
...
<!-- E N D : Main Container Table -->
	...
	<input type="hidden" name=medCompleteYN value="<bean:write name="frmAilmentDetails" property="medCompleteYN"/>"></input>
