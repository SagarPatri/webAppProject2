...
%>
<html:form action="/OnlineProviderClaimsShortfallAction.do" method="post" enctype="multipart/form-data">
...
<br>
	<fieldset><legend>Claim Request Details</legend>
		...
		<tr>
			<td style="width: 19%" align="left" class="formLabel"><b>Al Koot ID</b></td> 
			<td style="width: 1%" align="left">:</td>
