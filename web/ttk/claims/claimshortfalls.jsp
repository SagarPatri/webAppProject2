<%
/**
 * @ (#) claimshortfalls.jsp 30th July 2015
 * Project      : ProjectX
 * File         : claimshortfalls.jsp
 * Author       : Nagababu K
...
<script type="text/javascript" src="/ttk/scripts/claims/claimshortfalls.js"></script>
...
<html:form action="/ClaimShortfallsGeneralAction.do">
...
<legend>
<img src="/ttk/images/c.gif" title="Expand" name="ped0" width="16" height="16" align="top" onClick="showhide('Querie0','ped0')">&nbsp;Claim Shortfalls
</legend>

<table align="center" class="formContainerWithoutPad" border="0" cellspacing="0" cellpadding="0"  id="Querie0" style="display:;">
<logic:notEmpty name="claimShortFallData" scope="session">
<tr>
...
<c:forEach items="${sessionScope.claimShortFallData}" var="shdata">
<tr>
<td width="88%" class="formLabel">
    	...
    	<tr>
        	<td width="100%" align="center">
			    ...
			    <button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGenerateShortFall();"><u>V</u>iew Letter</button>&nbsp;
				  ...
				  <button type="button" name="Button" id="processBtn" accesskey="s" style="display:none;" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onSave();">Process Claim</button>&nbsp;      
...
<html:hidden  styleId="claimNo" property="claimNo" name="frmShortFall"/>
<html:hidden  styleId="claimSeqID" property="claimSeqID" name="frmShortFall"/>
...
<input type="hidden" name="authType" value="CLM">
<%-- 
