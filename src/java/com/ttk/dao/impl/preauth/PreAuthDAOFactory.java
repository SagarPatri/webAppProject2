...
//    private static Logger log = Logger.getLogger(PreAuthDAOFactory.class );
    ...
    public BaseDAO getDAO(String strIdentifier) throws TTKException {
        ...
        else if (strIdentifier.equals("preauthreferral"))
        {
        	baseDAO = new PreAuthReferralDAOImpl();
        }//end of else if (strIdentifier.equals("preauthreferral"))
        else if (strIdentifier.equals("dashboard"))
        {
            baseDAO = new PreAuthDashboardDAOImpl();
        }
        return baseDAO;
