<%
/** @ (#) pbmCheckEligibitily.jsp 12th July 2019
 * Project     : TTK Healthcare Services
 * File        : pbmCheckEligibitily.jsp
...
<%
	...
	pageContext.setAttribute("benifitType",Cache.getCacheObject("pbmBenefitTypes"));
		    ...
		    <table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0" >
		    	<tr>
			        ...
			        <% if((request.getAttribute("enrollId"))== null){ %>
			          <html:text property="enrollId" styleId="enrollId" name="frmPbmPreauthGeneral" 
			       ...
			       <td width="1%" align="left">:</td>
			        <td style="width: 59%">
			          <html:text property="treatmentDate" styleClass="textBox textDateNewDesign" maxlength="10" value="<%=TTKCommon.getServerDateNewFormat() %>" readonly="true"/>
       					<!-- <a name="CalendarObjectTreatmentDate" id="CalendarObjectTreatmentDate" href="#" onClick="javascript:show_calendar('CalendarObjectTreatmentDate','frmPbmPreauthGeneral.elements[\'treatmentDate\']',document.frmPbmPreauthGeneral.elements['treatmentDate'].value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;">
		      	...
		      	<tr>
			        ...
			        <td width="78%" colspan="3">
			          <html:text property="isdCode" name="frmPbmPreauthGeneral" size="3" maxlength="3" readonly="true" value="ISD" styleClass="textBox textBoxSmall"/>
			          <html:text property="mobileNo" name="frmPbmPreauthGeneral" styleClass="textBox textBoxMedium"/>
			        </td>
		      	</tr>
...
<%} %>	
	    ...
	    <!-- logic:match name="frmPbmPreauthGeneral" property="logicVar" value="true"-->	 
...
<%-- 	<input type="hidden" name="memberFingerPrintAuthenticated" id="memberAuthenticated" value="${memberFingerPrintAuthenticated}"/>
	<html:hidden property="fingerPrintStr" name="frmPbmPreauthGeneral" styleId="fingerPrintStr"/> --%>
	<br><br><br>
	</div>
</html:form> 