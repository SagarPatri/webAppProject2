...
<script language="javascript" src="/ttk/scripts/maintenance/criticalicdlist.js"></script>
...
<html:form action="/CriticalICDListAction.do" >
...
<div class="contentArea" id="contentArea">
	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td nowrap>Critical ICD Code:<br>
         ...
         <td nowrap>Critical ICD Description:<br>
