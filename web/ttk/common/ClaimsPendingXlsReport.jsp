<%@ page language="java" import="java.util.*,javax.naming.*,java.io.* "contentType="application/vnd.ms-excel"%>
  ...
  /* if (alClaimPendingData != null) { */
	    ...
	    response.setHeader("Content-Disposition",
				"attachment; filename="+ "claimPendingData.xls");
	/* } */
  %> 
     ...
     <td colspan="12"><%=compCode%></td>
      ...
      <tr bgcolor="#9999FF">
       ...
       <td><b>Transaction Reference Number</b></td>
       <td><b>Partner Name</b></td>
       <td><b>Payment Reference No</b></td>
       <td><b>IBAN Number</b></td>
       <td><b>Ageing as per received date</b></td>
       <td><b>Ageing as per Approved date</b></td>
       <td><b>Claim Batch No.</b></td>
       <td><b>Empanelment No.</b></td>
       <td><b>Bank Name</b></td>
       <td><b>Bank Account Number</b></td>
       <td><b>Swift Code</b></td>
        <td><b>Bank Location</b></td>
      </tr>
 ...
 %>
	...
	for(int i=0;i<alClaimPendingData.size();i++)	{
		...
		%>
			 ...
			 %>
			 <%
			 if(temp[43] != null || temp[43] != "" || temp[43] == "" || temp[43] == null){
				 break;
			 }
			 %>
		<%}
