...
import com.ttk.action.table.TableData;
 public class PageLinks1 extends TagSupport{
	...
	*/
    ...
    private static Logger log = Logger.getLogger( PageLinks1.class );
    String strName = "";
    String strScope = "";
    ...
    public int doStartTag() throws JspException {
		try
		{
            ...
            String rootpath =((javax.servlet.http.HttpServletRequest)pageContext.getRequest()).getContextPath();
			...
			{
				pageContext.getOut().print("&nbsp;<a href=\"#\" onClick=\"javascript:PressBackWard('"+this.strName+"')\"><img src=\""+rootpath+"/ttk/images/Prev.jpg\" alt=\"Previous Page\" width=\"10\" height=\"20\" border=\"0\"></a>&nbsp;&nbsp;");
			...
			for(int i=0;i<iPageLinks.length;i++)
			{
				...
				{
					pageContext.getOut().print("<a href=\"#\" class=\"v3PageLink\" onClick=\"javascript:pageIndex("+iPageLinks[i]+",'"+this.strName+"')\" title=\"Page "+(iAddPageNum + iPageLinks[i])+"\">"+ (iAddPageNum + iPageLinks[i]) +"</a>");
					pageContext.getOut().print("&nbsp;");
				}//end of if(iPageLinks[i]!=iCurrentPage)
				else
				{
					pageContext.getOut().print("<span class=\"v3CurrentPageLink\">"+(iAddPageNum + iPageLinks[i])+"</span>");
					pageContext.getOut().print("&nbsp;");
				}//end of else
			...
			{
				pageContext.getOut().print("&nbsp;&nbsp;<a href=\"#\" onClick=\"javascript:PressForward('"+this.strName+"')\"><img src=\"/ttk/images/Next.png\" alt=\"Next Page\" width=\"10\" height=\"20\" border=\"0\"></a>");
