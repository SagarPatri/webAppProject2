/** @ (#) retailSearch.js 21 Aug 2015
 * Project     : TTK Healthcare Services
 * File        : retailSearch.js
...
//on proceed onRetailSearchProceed
function onRetailSearchProceed()
{
	document.forms[1].mode.value="doRetailSearchProceed";
   	document.forms[1].action="/EditInsuranceRetailAction.do";
   	document.forms[1].submit();
}
...
function edit(rownum)
{
    ...
    document.forms[1].mode.value="doRetailGlobalFocusedView";
