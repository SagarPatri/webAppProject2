...
<td nowrap>Treatment Start date:<span class="mandatorySymbol">*</span><br>
  ...
  <html:text name="frmProviderReportsList" property="tmtfromDate" maxlength="10" styleClass="textBoxDate"/>
  ...
  <html:text name="frmProviderReportsList" property="tmttoDate" maxlength="10" styleClass="textBoxDate"/>
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
												HREF="#"
  ...
  <html:text name="frmProviderReportsList" property="clmFromDate" maxlength="10" styleClass="textBoxDate"/>
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
												HREF="#"
  ...
  <html:text name="frmProviderReportsList" property="clmToDate" maxlength="10" styleClass="textBoxDate"/>
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
												HREF="#"
 ...
 <tr>
	  ...
	  <html:text property="invoiceNo" name="frmProviderReportsList" styleClass="textBox textBoxMedLarge"/>
	  </td>
	
		<td nowrap>Batch Number:<br>
	  <html:text property="batchNo" name="frmProviderReportsList" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  ...
	  <html:text property="claimNo" name="frmProviderReportsList" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  </tr>
	  <tr>
	  ...
	  <html:text property="payRefNo" name="frmProviderReportsList" styleClass="textBox textBoxMedLarge"/>
...
<%if(("claimSummary".equals(request.getSession().getAttribute("reportId")))){%>
<div align="left">
<table>
<tr><td><b>NOTE:-</b></td></tr>
<tr><td><b><small>Where the payment confirmation is not available with us, the reference number is not provided. For more details regarding the payment please contact Al Koot</small></b></td></tr>
</table>
</div>
<%}%>

<%if(("claimDetailed".equals(request.getSession().getAttribute("reportId")))){%>
<div align="left">
<table>
<tr><td><b>NOTE:-</b></td></tr>
