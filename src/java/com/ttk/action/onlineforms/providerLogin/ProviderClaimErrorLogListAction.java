/**
* @ (#) ProviderClaimErrorLogListAction.java
*/
...
public class ProviderClaimErrorLogListAction extends TTKAction
{
	private static Logger log = Logger.getLogger(ProviderClaimErrorLogListAction.class);
