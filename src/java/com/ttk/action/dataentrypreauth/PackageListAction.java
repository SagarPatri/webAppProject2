...
public class PackageListAction extends TTKAction{
	...
	private static final String strClaimsPackageList="dataentryclaimspackagelist";
	...
	private static final String strCodeClaimsPackageList="dataentrycodeclaimspackagelist";
	...
	public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try
		{
			...
			ParallelTariffManager tariffItemObject=this.getTariffItemObject();  //get the session bean from the bean pool
			TableData packageListData = null;
			if((request.getSession()).getAttribute("packageListData") != null){
				packageListData = (TableData)(request.getSession()).getAttribute("packageListData");
			}//end of if((request.getSession()).getAttribute("packageListData") != null)
	...
	public ActionForward doSelectPackage(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try
		{
			...
			if(strLinks.equals("DataEntryCoding"))
			{
	...
	private void getCaption(DynaActionForm formSearchAssociate,HttpServletRequest request)throws TTKException
	{
		try
		{
			...
			if(strLink.equals("DataEntryCoding"))
			{
	...
	/**
	 * Returns the ParallelTariffManager  session object for invoking methods on it.
	 * @return ParallelTariffManager session object which can be used for method invokation
	 * @exception throws TTKException
	 */
	private ParallelTariffManager getTariffItemObject() throws TTKException
	{
		ParallelTariffManager tariffItem = null;
		try
		{
			if(tariffItem == null)
			{
				InitialContext ctx = new InitialContext();
				tariffItem = (ParallelTariffManager) ctx.lookup("java:global/TTKServices/business.ejb3/ParallelTariffManagerBean!com.ttk.business.dataentryadministration.ParallelTariffManager");
			}//end of if(user == null)
		}//end of try
		catch(Exception exp)
		{
