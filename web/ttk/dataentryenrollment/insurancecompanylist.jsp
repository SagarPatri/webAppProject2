...
<script language="javascript" src="/ttk/scripts/dataentryenrollment/insurancecompanylist.js"></script>
...
<html:form action="/DataEntryChangeOfficeAction.do" >
	<!-- S T A R T : Page Title -->
<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Select Healthcare Company Branch <logic:match name="strSubLink"  value="Float Account"><bean:write name="frmEnrlInsCompany" property="caption"/></logic:match></td>
  </tr>
</table>
	<!-- E N D : Page Title -->
	<html:errors/>
...
<!-- E N D : Main Container Table -->
	...
	<input type="hidden" name="child" value="Healthcare Company">
