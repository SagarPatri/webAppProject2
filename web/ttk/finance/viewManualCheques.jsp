<%
/**
 * @ (#) viewManualCheques.jsp 4th Nov 2019
 * Project      : TTK HealthCare Services
 * File         : viewManualCheques.jsp
 * Author       : Deepthi Meesala
 * Company      : RCS
 * Date Created : 4th Nov 2019
 */
%>
...
<script language="javascript" src="/ttk/scripts/finance/viewManualCheques.js"></script>
...
<%}%>
	...
	<html:errors />
<html:form action="/ViewManualChequePrintingsAction.do">
	<html:errors />
