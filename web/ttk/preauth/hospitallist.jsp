...
<script language="javascript" src="/ttk/scripts/preauth/hospitallist.js"></script>
...
<!-- S T A R T : Content/Form Area -->
	<html:form action="/SelectHospitalAction.do">
	<!-- S T A R T : Page Title -->

	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">

	  <tr>
	    <td>Select Providers</td>
	  </tr>
	</table>
	<!-- E N D : Page Title -->
	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    	...
	    	<logic:match name="ActiveLink" value="Support">
		    	<td nowrap>Vidal Health&nbsp;Reference&nbsp;No.:<br>
     	  ...
     	  <td valign="bottom" nowrap width="100%" align="left">
     	  	<a href="#" class="search" accesskey="s" onClick="onSearch()" ><img src="/ttk/images/SearchIcon.gif" title="Search" width="16" height="16" border="0" align="absmiddle">&nbsp;<u>S</u>earch</a>
		  </td>
 		</tr>
	</table>
	<!-- E N D : Search Box -->
