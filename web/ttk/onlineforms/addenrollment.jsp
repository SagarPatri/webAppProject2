	...
	<div class="contentArea" id="contentArea">
 		...
 		<logic:notEmpty name="statusinfo" scope="request">
			 <table align="center" class="errorContainer" style="display:" border="0" cellspacing="0" cellpadding="0">
				 <tr>
					 <td>
					 	<strong>
					 		<img src="/ttk/images/ErrorIcon.gif" title="Error" alt="Error" width="16" height="16" align="absmiddle">&nbsp;
					 	</strong>
       ...
       <logic:notEqual name="frmAddEnrollment" property="allowCityBankYN" value="Y">
		   ...
		   <legend>Employee Information</legend>
				<table align="center" class="formContainerWeblogin"  border="0" cellspacing="0" cellpadding="0">
			      	<tr>
			        	...
			        	<td width="30%">
			        		<html:text property="insuredName" styleClass="textBoxWeblogin textBoxLargeWeblogin" maxlength="100" styleId="insuredName"/>
			        	</td>			        	   
			      	...
			      	<td class="formLabelWeblogin" width="19%">Relationship:</td>
			        	<td width="30%">
			        	<logic:notEmpty property="relationship" name="frmAddEnrollment">		        	
			        	 <html:select property="relationship" readonly="true" styleClass="selectBox selectBoxMedium" style="background-color: #EEEEEE;" disabled="true">
         						 <html:optionsCollection name="listRelationshipCode" label="cacheDesc" value="cacheId"/>
    					  </html:select>
			        	</logic:notEmpty>
			        	<logic:empty property="relationship" name="frmAddEnrollment">		        	
			        	 <html:select property="relationship" styleClass="selectBox selectBoxMedium" disabled="false" style="background-color: #EEEEEE;" readonly="true">
         						 <html:optionsCollection name="listRelationshipCode" label="cacheDesc" value="cacheId"/>
    					  </html:select>
			        	</logic:empty>
			      	...
			      	<tr>
			        	...
			        	<td>
			        		<html:text property="department" styleClass="textBoxWeblogin textBoxMediumWeblogin" maxlength="60" />
			        	</td>
		...
		<legend>Personal Information</legend>
				...
				<table align="center" class="formContainerWeblogin"  border="0" cellspacing="0" cellpadding="0">
			      	<tr>
			        	...
			        	<td width="30%" nowrap>
			  				...
			  				<td class="formLabelWeblogin" width="19%">Gender:
			  				<logic:empty property="relationship" name="frmAddEnrollment">
			  				  <span class="mandatorySymbol">*</span> 
			  				  </logic:empty></td>
			        	<td width="30%">
			        	<logic:empty property="genderTypeID" name="frmAddEnrollment">		        	
			        	 <html:select property="genderTypeID" readonly="true" styleClass="selectBox selectBoxMedium" disabled="false">
         						 	 	<html:option value="">SELECT FROM LIST</html:option>
           								 <html:option value="MAL">Male</html:option>
           								 <html:option value="FEM">Female</html:option>
          							</html:select>
			        	</logic:empty>	      
			        	<logic:notEmpty property="genderTypeID" name="frmAddEnrollment">  	
          							<html:select property="genderTypeID" readonly="true" styleClass="selectBox selectBoxMedium" style="background-color: #EEEEEE;" disabled="true">
         						 	 	<html:option value="">SELECT FROM LIST</html:option>
           								 <html:option value="MAL">Male</html:option>
           								 <html:option value="FEM">Female</html:option>
          							</html:select>
					...
					<tr>
 							 <td class="formLabel">Date of Birth:<span class="mandatorySymbol">*</span></td>
							   ...
							   <logic:empty property="dateOfBirth" name="frmAddEnrollment">
							   <html:text property="dateOfBirth" styleId="Dob" styleClass="textBox textDate" onfocus="convertToHDate('HDob')" onblur="javascript:convertToHDate('HDob');onDateofBirth();" maxlength="10" disabled="<%=viewmode%>"/>
    							<a name="CalendarObjectdobDate" id="CalendarObjectdobDate" href="#" onClick="javascript:show_calendar('CalendarObjectdobDate','frmAddEnrollment.dateOfBirth',document.frmAddEnrollment.dateOfBirth.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="/ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar" name="dobDate" width="24" height="17" border="0" align="absmiddle"></a>
							   </logic:empty>
							   <logic:empty property="hdateOfBirth" name="frmAddEnrollment">
							   <html:text property="hdateOfBirth" styleId="HDob" styleClass="textBox textDate" maxlength="10" disabled="<%=viewmode%>" onfocus="convertToGDate('Dob')" onblur="javascript:convertToGDate('Dob');onDateofBirth();"/>					
  							  	<a name="HCalendarObjectdobDate" ID="HDob" HREF="#" onClick="javascript:show_Hcalendar('HDob','forms[1].hdateOfBirth',document.forms[1].hdateOfBirth.value,'',event,148,178);return false;" onMouseOver="window.status='Hijri-Calendar';return true;" onMouseOut="window.status='';return true;"><img src="/ttk/images/HCalendarIcon.gif" title="Hijri-Calendar" alt="Hijri-Calendar"  width="24" height="17" border="0" align="absmiddle"></a>   
							   </logic:empty>
							   <logic:notEmpty property="dateOfBirth" name="frmAddEnrollment">
    							...
    							<a name="CalendarObjectdobDate" id="CalendarObjectdobDate" href="#" onClick="javascript:show_calendar('CalendarObjectdobDate','frmAddEnrollment.dateOfBirth',document.frmAddEnrollment.dateOfBirt.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="/ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar" name="dobDate" width="24" height="17" border="0" align="absmiddle"></a>
    							</logic:notEmpty>
    							<logic:notEmpty property="hdateOfBirth" name="frmAddEnrollment">
    							<html:text property="hdateOfBirth" styleId="HDob" styleClass="textBox textDate" maxlength="10"  style="background-color: #EEEEEE;" readonly="true" onfocus="convertToGDate('Dob')" onblur="javascript:convertToGDate('Dob');onDateofBirth();"/>					
  							  	<a name="HCalendarObjectdobDate" ID="HDob" HREF="#" onClick="javascript:show_Hcalendar('HDob','forms[1].hdateOfBirth',document.forms[1].hdateOfBirt.value,'',event,148,178);return false;" onMouseOver="window.status='Hijri-Calendar';return true;" onMouseOut="window.status='';return true;"><img src="/ttk/images/HCalendarIcon.gif" title="Hijri-Calendar" alt="Hijri-Calendar"  width="24" height="17" border="0" align="absmiddle"></a>   
    							</logic:notEmpty>
    				</td>
    			...
    			<td class="formLabelBold">
    	 <html:select name="frmAddEnrollment" property="nationality" styleId="nationality" styleClass="selectBox selectBoxMedium" disabled="<%=viewmode%>" onchange="changeManSym();">
  	 		  <html:option value="">Select from list</html:option>
		      <html:optionsCollection name="nationalities" label="cacheDesc" value="cacheId" /> 
		</html:select>
    </td>
    <td class="formLabel">Marital Status:
    <logic:empty name="frmAddEnrollment" property="maritalStatus">
    <span class="mandatorySymbol">*</span>
    </logic:empty>
    </td>
    <td class="formLabelBold">   
    <logic:notEmpty name="frmAddEnrollment" property="maritalStatus"> 	
		 <html:select property="maritalStatus" styleId="maritalStatus" styleClass="selectBox selectBoxMedium" disabled="true">
  	 		  <html:option value="">Select from list</html:option>
		      <html:optionsCollection name="maritalStatuses" label="cacheDesc" value="cacheId" /> 
		</html:select>
		</logic:notEmpty>
		<logic:empty name="frmAddEnrollment" property="maritalStatus">
		 <html:select property="maritalStatus" styleId="maritalStatus" styleClass="selectBox selectBoxMedium" disabled="<%=viewmode%>">
  	 		  <html:option value="">Select from list</html:option>
		      <html:optionsCollection name="maritalStatuses" label="cacheDesc" value="cacheId" /> 
		</html:select>
		</logic:empty>
        ...
        <td>
          ...
          <html:text property="memberAddressVO.mobileNbr" styleClass="textBox textBoxMedium" maxlength="25" disabled="<%=viewmode%>"/>
		      	...
		      	<td class="formLabelWeblogin">Residential Location:</td>
			        <td>
			        	<html:text name ="frmAddEnrollment" property="residentialLocation"  styleClass="textBoxWeblogin textBoxMediumWeblogin"  maxlength="10" disabled="<%=viewAddress%>" />
			        </td>
			        <td class="formLabelWeblogin">Work Location:</td>
			        <td>
			        	<html:text name ="frmAddEnrollment" property="workLocation"  styleClass="textBoxWeblogin textBoxMediumWeblogin"  maxlength="10" disabled="<%=viewAddress%>" />
			        </td>
		      	</tr>
		      	<tr>
			        <td>Fax:</td>
       ...
       <tr>
         ...
         <tr>
              ...
              <tr>
                ...
                <td width="19%" class="formLabel">Swift Code: <span class="mandatorySymbol">*</span></td>
                 <td width="32%">
                 <logic:equal name="frmAddEnrollment" property="bankAccountQatarYN" value="N">
                 <html:text property="ifsc" styleClass="textBox textBoxMedium"  maxlength="60" onkeyup="ConvertToUpperCase(event.srcElement);"/>
                 </logic:equal>
                 <logic:notEqual name="frmAddEnrollment" property="bankAccountQatarYN" value="N">
                  <html:text property="ifsc" styleClass="textBox textBoxMedium" style="background-color: #EEEEEE;" maxlength="60" readonly="true"/>
                </logic:notEqual>
                 </td>
                </tr>
                <tr>                                 
                 ...
                 <td width="32%">
                  <html:text property="micr" styleClass="textBox textBoxMedium"  maxlength="29" onkeyup="ConvertToUpperCase(event.srcElement);"/>
                 </td>  
		      	 	...
		      	 	<td></td> <td></td>
						  <td align="right"  valign="bottom">							
   									 ...
   									 <logic:equal name="frmAddEnrollment" property="photoYN" value="Y">						
   										 <img src="/GetImageAction.do?mode=dohelloImage" title="Image" alt="Image" width="120" height="120"  style="border:2px solid black;"/> 
						  			 </logic:equal>
						  			 <logic:notEqual name="frmAddEnrollment" property="photoYN" value="Y">						
   										 <img src="/ttk/images/UploadPhoto.gif" title="Image" alt="Image" width="120" height="120"  style="border:2px solid black;"/> 
						 			  </logic:notEqual>
						   		</td>
				</tr> 
	    	</table>	  
		...
		<logic:match name="frmAddEnrollment" property="v_OPT_ALLOWED" value="WSA">
		  <fieldset>
			...
			I confirm that I <b><font size=3>DO NOT</font></b> wish to participate in IBM's Group Hospitalization Policy. I understand and agree that by
			clicking on the button below, I will 'opt out' of IBM's Group Hospitalization Policy and my nuclear family (spouse
			 and children) and I will no longer be eligible to participate in such Policy, or avail of any benefits under this
			 Policy. I fully understand the implications of not being part of the Policy, and agree to the same. I also confirm
			 that neither my family (spouse and children) nor I shall claim that we are entitled to any benefits under IBM's
			Group Hospitalization Policy.</font></td>
...
<!--   										<button type="button" name="Button" accesskey="c" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onHRClose()"><u>C</u>lose</button>
 -->									</logic:notEqual>
				...
				<logic:equal name="ActiveSubLink" value="Member Info">
		    	<%
		    		 if(TTKCommon.isAuthorized(request,"Edit"))
    				{
    			%>
				...
				<% }%>
		    		...
		    		<button type="button" name="Button" accesskey="c" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onCloseWindow()"><u>C</u>lose</button><!-- close-->
		    	</td>
	    	</tr>
		</table>
	</div>
	...
	<INPUT TYPE="hidden" NAME="loginType" value="<%=userSecurityProfile.getLoginType()%>">
  	...
  	<input type="hidden" name="actualPrincipalName" id='actualPrincipalName' value='${sessionScope.principalName}'>
