...
<!-- S T A R T : AllReportsList -->
    ...
    <tr>
						...
						<td nowrap>To Date <span class="mandatorySymbol">*</span></td>
						<td>
    ...
    <table align="center" class="buttonsContainer" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100%" align="center">Report Type 
				...
				<button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'"	onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGenerateTATReport();"><u>G</u>enerateReport</button>
				&nbsp;
