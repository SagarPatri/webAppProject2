	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
      <tr>
      	...
      	<td width="21%" nowrap>Policy Name:<br>
        	<html:text property="schemeName" styleId="search3" styleClass="textBox textBoxMedium" maxlength="60" onkeyup="ConvertToUpperCase(event.srcElement)"/>
		</td>
        <td width="10%" nowrap>Certificate No.:<br>
        	<html:text property="certificateNo" styleId="search4" styleClass="textBox textBoxMedium" maxlength="60" onkeyup="ConvertToUpperCase(event.srcElement)"/>
		</td>
      ...
      <tr>
        <td nowrap>Policy No.:<br>
         ...
         <td nowrap>Qatar ID:<br>
		    	<html:text property="sQatarId"  styleId="search10"  styleClass="textBox textBoxMedium" maxlength="60" />
		    </td>	
        ...
        <a href="#" class="search" accesskey="s" onClick="onSearch(this)" ><img src="/ttk/images/SearchIcon.gif" title="Search" width="16" height="16" border="0" align="absmiddle">&nbsp;<u>S</u>earch</a>
      </tr>
    </table>
	<!-- E N D : Search Box -->
    <!-- S T A R T : Grid -->
