 ...
 */
public class AwaitingClaimsTable extends Table {
	/**
	 ...
	 */
	    ...
	    /*  //Setting properties for Claim No.
	       ...
	       // colClaimNo.setImageName("");
	       // colClaimNo.setImageTitle("");
	        colPreAuth.setVisibility(false);
	        colPreAuth.setHeaderLinkTitle("Sort by: PreAuth No.");
	        colPreAuth.setDBColumnName("PREAUTH_NUMBER");
	        addColumn(colPreAuth);
	        */
	        
	       
	        //Setting properties for  Claim Amount.
	        Column colClaimAmount=new Column("Rec. Claim Amount");
	        ...
	        Column colClaimReommendedDate=new Column("Claim Rec. Date");
	        ...
	        colClaimReommendedDate.setHeaderLinkTitle("Sort by:Claim Reommended Date");
	        colClaimReommendedDate.setDBColumnName("DATE_OF_ADMISSION");
	        ...
	        colAdmDate.setMethodName("getClaimAdmnDate");
	        ...
	        //CLAIM_STATUS
	        Column colClaimStatus=new Column("TPA Status");
	        colClaimStatus.setMethodName("getPreAuthClaimStatus");
	        colClaimStatus.setColumnWidth("10%");
	        colClaimStatus.setIsHeaderLink(true);
	        colClaimStatus.setHeaderLinkTitle("Sort by: Status");
	        colClaimStatus.setDBColumnName("CLAIM_STATUS");
