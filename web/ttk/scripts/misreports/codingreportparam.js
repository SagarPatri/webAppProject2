...
function onGenerateReport()
{
 ...
 var ReportBasedOn=document.getElementById("reportBasedOn").value
	...
	var reportID= new String("CODRPT");
	...
	{
	var fileName = "reports/misreports/CodingReport.jrxml";
	}
	if(document.forms[1].reportType.value=="PDF")
	{
	var fileName = "reports/misreports/CodingReport.jrxml";
	}
	parameterValue ="|S|"+ReportBasedOn+"|"+startDate+"|"+endDate+"|";
	...
	var openPage = "/CodingReportsListAction.do"+partmeter;
