...
function pageIndex(pagenumber)
{
    ...
    document.forms[1].action = "/ProviderReSubmissionClaimViewLogListAction.do";
...
{
    var openPage = "/ProviderReSubmissionClaimViewLogListAction.do?mode=doViewErrorLog&reportType=EXCEL&rownum="+rownum;
