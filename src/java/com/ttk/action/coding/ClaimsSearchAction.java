...
public class ClaimsSearchAction extends TTKAction
{
	...
	private static final  String strClaimslist="claimsSearch";
	private static final  String strClaimDetail="claimsdetail";
    ...
    public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    												HttpServletResponse response) throws Exception{
    	try{
    		log.info("Inside the doSearch method of ClaimsSearchAction");
    		setLinks(request);
