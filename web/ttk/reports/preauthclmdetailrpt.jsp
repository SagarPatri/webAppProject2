<%
/** @ (#) preauthclmdetailrpt.jsp
 * Project     : TTK Healthcare Services
 * File        : preauthclmdetailrpt.jsp
...
<script language="javascript" src="/ttk/scripts/reports/preauthclmdetailrpt.js"></script>
<script language="javascript" src="/ttk/scripts/calendar/calendar.js"></script>
<html:form action="/PreAuthClmReportAction.do">
	<!-- S T A R T : Page Title -->
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>Cashless Reports - Cashless/Claim Detail Report</td>
		</tr>
	</table>
	<!-- E N D : Page Title -->
		...
		<legend>Report Parameters </legend>
			<table border="0" align="center" cellpadding="0" cellspacing="0" class="formContainer">
				<tr>
					...
					<td>
						<html:text property="groupId"	styleClass="textBox textBoxMedium" maxlength="60"  style="background-color: #EEEEEE;" readonly="true"/>&nbsp;&nbsp;&nbsp; 
					...
					<td>
						<html:select property="policySeqID"  styleClass="selectBox selectBoxLarge" onchange="javascript:onSelectPolicy();">
	...
	<table align="center" class="buttonsContainer" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100%" align="center">Report Type 
				...
				<button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'"	onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGeneratePreAuthClmReport();"><u>G</u>enerateReport</button>
				&nbsp;
