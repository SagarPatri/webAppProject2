...
<script language="javascript" src="/ttk/scripts/reports/ibmchildbornreportparam.js"></script>
	...
	<table align="center" class="buttonsContainer" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td width="100%" align="center">Report Type
				...
				<button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'"	onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGenerateChildBornReport();"><u>G</u>enerateReport</button>
				&nbsp;
