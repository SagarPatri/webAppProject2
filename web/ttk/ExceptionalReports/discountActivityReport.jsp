...
<SCRIPT type="text/javascript"  SRC="/ttk/scripts/ExceptionaReports/discountActivityReport.js"></SCRIPT>
</head>
<%
...
<table align="center" class="tablePad"  border="0" cellspacing="0" cellpadding="0">
	 <tr>
		        ...
		        <td width="90%">
			    <html:select property="switchType" name="frmClaimsDiscountActReport" styleClass="selectBox selectBoxMedium" onchange="onSwitch();">
...
<td nowrap>Treatment Start date:<span class="mandatorySymbol">*</span><br>
  ...
  <html:text name="frmClaimsDiscountActReport" property="tmtfromDate" maxlength="10" styleClass="textBoxDate"/>
  ...
  <html:text name="frmClaimsDiscountActReport" property="tmttoDate" maxlength="10" styleClass="textBoxDate"/>
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
												HREF="#"
  ...
  <html:text name="frmClaimsDiscountActReport" property="clmFromDate" maxlength="10" styleClass="textBoxDate"/>
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
												HREF="#"
  ...
  <html:text name="frmClaimsDiscountActReport" property="clmToDate" maxlength="10" styleClass="textBoxDate"/>
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
												HREF="#"
 ...
 <td nowrap>Provider Name:<!-- <span class="mandatorySymbol">*</span> --><br>
		    <html:select property="sProviderName" name="frmClaimsDiscountActReport"  styleClass="selectBox selectBoxMoreMedium">
		    	 <html:option value="">Any</html:option>
  				<html:options collection="ProviderList"  property="cacheId" labelProperty="cacheDesc"/>
		    </html:select>
        </td>
	    <logic:equal property="switchType" name="frmClaimsDiscountActReport" value="IPTR">
        <td nowrap>Partner Name:<br>
	    <html:select property="partnerNm" name="frmClaimsDiscountActReport" styleClass="selectBox selectBoxMedium">
	  ...
	  <html:text property="patientName" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge"/>
 </td>
        
 	 <td nowrap>Claim Status:<br>
	    <html:select property="claimStatus" name="frmClaimsDiscountActReport" styleClass="selectBox selectBoxMedium">
		  	 		<html:option value="">Any</html:option>
	  ...
	  <html:text property="invoiceNo" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge"/>
	  </td>
	</tr>
	  <tr>
		<td nowrap>Claims Batch Number:<br>
	  <html:text property="batchNo" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  
	  <td nowrap>Al Koot Id:<br>
	  <html:text property="alKootId" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  
	  <td nowrap>Claim Number:<br>
	  <html:text property="claimNo" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  <td nowrap>Benefit Type:<br>
	  <html:select property ="benefitType" styleClass="selectBox selectBoxMedium" styleId="benefitType" name="frmClaimsDiscountActReport">
           			<html:option value="">Select from list</html:option>
	  ...
	  <html:text property="eventRefNo" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge" style="background-color: #EEEEEE;" readonly="true"/>
	  </td>
	  
	   <td nowrap>Qatar Id:<br>
	  <html:text property="qatarId" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge" style="background-color: #EEEEEE;" readonly="true"/>
	  </td>
	  
	  <td nowrap>Payment Reference Number:<br>
	  <html:text property="payRefNo" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge"/>
       <!-- <a href="#"><button name="mybutton" class="olbtn" accesskey="s" onclick="return onSearch();" type="button"><u>S</u>earch</button></a> -->  
	  </td>
	 
	<logic:notEqual property="switchType" name="frmClaimsDiscountActReport" value="IPTR"> 
	  <td nowrap>Finance Batch Number:<br>
	  <html:text property="finBatchNo" name="frmClaimsDiscountActReport" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  <td nowrap>Finance Status:<br>
	    <html:select property="financeStatus" name="frmClaimsDiscountActReport" styleClass="selectBox selectBoxMedium">
		  	 		<html:option value="">Select from list</html:option>
...
<!-- E N D : Search Box -->
 ...
 <td colspan="4">&nbsp;</td>
  <logic:equal property="switchType" name="frmClaimsDiscountActReport" value="QPR">
  ...
  <td colspan="4"><button name="closeButton" class="olbtnLarge" accesskey="c" onclick="onClose();" type="button"><u>C</u>lose</button></td>
  </tr>
</table>
