<%
/**
 * @ (#) financeAccountReview.jsp 4th Sep 2018
 * Project      : TTK HealthCare Services
 * File         : financeRevisedAccountReview.jsp
...
<script language="javascript" src="/ttk/scripts/finance/financeRevisedAccountValidate.js"></script>
...
<!-- S T A R T : Page Title -->
	...
	<table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    ...
	    <td width="33%"><html:text property="bankname" styleClass="textBox textBoxLarge" maxlength="250" onkeyup="ConvertToUpperCase(event.srcElement);" style="background-color: #EEEEEE;"  readonly="true"  disabled="true" />
	    </td>
	 ...
	 <tr>
	    ...
	    <td><html:text property="swiftCode" styleClass="textBox textBoxMedium" maxlength="60" style="background-color: #EEEEEE;"   readonly="true"  disabled="true" />
	 	</td>
	    <td class="formLabel">Swift Code:</td>
	    <td><html:text property="iBanNo" styleClass="textBox textBoxLarge" maxlength="250" style="background-color: #EEEEEE;"   readonly="true"  disabled="true" />
		</td>
	  </tr>
	  <!-- E N D -->
     ...
     <tr>
		<td width="21%" class="formLabel">Finance Reviewed Yes/No:</td>
		 <td width="32%">
		<html:checkbox property="reviewedYN" styleId="reviewYN" />
		</td>
	 </tr>
