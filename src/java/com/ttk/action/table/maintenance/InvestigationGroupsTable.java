...
public class InvestigationGroupsTable extends Table{
	public void setTableProperties()
    {
        ...
        //Setting properties for Name koc11 koc 11
        Column colName = new Column("Name");
        colName.setMethodName("getGroupName");
        colName.setColumnWidth("92%");
        ...
        colName.setDBColumnName("AGENCY_NAME");
        addColumn(colName);
...
}//end of class InvestigationGroupsTable