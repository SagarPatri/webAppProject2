...
public class HospPreAuthVO extends BaseVO{
	...
	//New Req Kishor
    private String strPateintName="";
    private Date dtDischargeDate=null;
    
    
    public void setPatientName(String strPateintName) {
		this.strPateintName = strPateintName;
	}
	public String getPatientName() {
		return strPateintName;
	}
	...
	public void setDischargeDate1(Date dtDischargeDate) {
