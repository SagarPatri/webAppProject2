...
pageContext.setAttribute("cpStatus", Cache.getCacheObject("claimPaymentStatus"));
%>
...
<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="1" id="onlineSearchEnterTable">
 ...
 <td nowrap>Invoice No.:<br>
	  <html:text property="invoiceNumber" name="frmPBMReportsList" styleClass="textBox textBoxMedLarge"/>
	  </td>
  ...
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
	...
	<td nowrap>Batch Number:<br>
	 <html:text property="batchNo" name="frmPBMReportsList" styleClass="textBox textBoxMedLarge"/>  
	</td>
	<logic:match name="frmPBMReportsList" property="reportName" value="Claim wise payment report">
	<td nowrap>Payment Reference Number:<br>
	 <html:text property="paymentRefNo" name="frmPBMReportsList" styleId="ClaimpaymentRefNoId" styleClass="textBox textBoxMedLarge"/>  
	</td>
	<td nowrap>Claim Payment Status:<br>
	   <html:select property="clmPayStatus" name="frmPBMReportsList" styleClass="selectBox selectBoxMedium">
	                <html:option value="">Any</html:option>
		        	<html:optionsCollection name="cpStatus" label="cacheDesc" value="cacheId" />
            	</html:select></td>
	</logic:match>
	<logic:match name="frmPBMReportsList" property="reportName" value="Drug wise payment report">
	<td nowrap>Payment Reference Number:<br>
	 <html:text property="paymentRefNo" name="frmPBMReportsList" styleId="DrugpaymentRefNoId" styleClass="textBox textBoxMedLarge"/>  
	</td>
	</logic:match>
	  	<td>
	   ...
	   <button name="mybutton" class="olbtn" accesskey="s" onclick="return onSearch();" type="button"><u>S</u>earch</button>	 
	   </a>  
      </td>    	 
