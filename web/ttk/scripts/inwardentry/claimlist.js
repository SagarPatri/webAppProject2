...
//function to sort based on the link selected
	function toggle(sortid)
	{
	    ...
	    document.forms[1].action = "/EnrollmentListAction.do?claimlist=claimlist";
	...
	function onClose()
	{
		document.forms[1].mode.value = "doSelectClaim";
		document.forms[1].child.value="";
	    document.forms[1].action = "/EnrollmentListAction.do";
	    document.forms[1].submit();
	}//end of onClose()
