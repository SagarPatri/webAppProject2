<%
/** @ (#) idcpsreports.jsp May 18, 2007
 * Project     : TTK Healthcare Services
 * File        : idcpsreports.jsp
 * Author      : Ajay Kumar
...
<script language="javascript" src="/ttk/scripts/misreports/idcpsreports.js"></script>
...
<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
	<tr>
    	<td width="51%">Id Cards Pending Sumary Report</td>
...
<tr>
		...
		<td><html:select property="tTKBranchCode" styleClass="selectBox selectBoxMedium" disabled="<%= viewmode %>">
		  	 	  <!-- <html:option value="">Select from list</html:option> -->
		  	 	  <html:option value="ALL">ALL</html:option>
		  	 	  <html:optionsCollection name="ttkOfficeInID" label="cacheDesc" value="cacheId" />
            </html:select>
	    </td>
	    </tr>
	<tr>
