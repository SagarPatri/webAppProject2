...
public class ProviderShortFallQueries extends TagSupport{
	...
	*/
	...
	private String flow;
    private static Logger log = Logger.getLogger( ProviderShortFallQueries.class );
    ...
    public int doStartTag() throws JspException{
		...
		try
		{
	        ...
	        if(queryNodes!=null&&queryNodes.size()>=1){
	        	...
	        	out.print("</legend>");*/
	        	out.print("<table align='center' class='formContainerWithoutPad' border='0' cellspacing='0' cellpadding='0'  id="+QuerieName+"  width='80%'>");
	        	/*  	out.print("<tr>");
	        	...
	        	*/
	        	String name=subsectionNode.valueOf("@name");
	        	 ...
	        	 out.print("</table>");
        		 /*out.print("</fieldset>");	NO  FIELD SET ONLY DATA*/
        		 ii++;
	        }//if(queryNodes!=null&&queryNodes.size()>=1){
        }//for(Node subsectionNode:subsectionNodeList){
    		...
    		if(otherQueryNode!=null){
	        	...
	        	out.print("</legend>");
	        	*/out.print("<table align='center' class='formContainerWithoutPad' border='0' cellspacing='0' cellpadding='0'  id='Querie0'  width='80%'>");//style='display:none;'
	        	/*out.print("<tr>");
	        	out.print("<td class='formLabel'>");
	        	out.print("</td>");*/
    			out.print("<tr>");
        		out.print("<td  class='formLabel'>");
        		String areaBoxDis="readonly";
        		...
        		/*out.print("<textarea name='OtherQueries' "+areaBoxDis+" class='textBox textAreaLarge'  id='OtherQueries'>"+value+"</textarea>");*/
        		out.print(value); 
        		out.print("</td>");
        		out.print("</tr>");
        		out.print("</table>");
