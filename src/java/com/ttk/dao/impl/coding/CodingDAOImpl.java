...
public class CodingDAOImpl implements BaseDAO, Serializable {
	...
	private static final String strGetClaimList = "{CALL CODING_PKG.SELECT_CODING_CLAIMS_LIST(?,?,?,?,?,?,?,?,?,?,?)}";
	private static final String strGetClaimCodeCleanList = "{CALL CODE_CLEANUP_PKG.SELECT_CLAIMS_LIST(?,?,?,?,?,?,?,?,?,?,?,?)}";
	private static final String strGetClaimDetail = "{CALL CODING_PKG.SELECT_CODING_CLAIM(?,?,?)}";
	private static final String strGetCodeCleanupClaimDetail = "{CALL CODE_CLEANUP_PKG.SELECT_CLAIM(?,?,?)}";
	private static final String strGetAilmentList = "{CALL CODING_PKG.SELECT_AILMENT_LIST(?,?,?)}";
		...
		try
		{
			...
			if(rs!= null)
			{
				while(rs.next())
				{
					...
					cacheObject.setCacheId(rs.getString("DIAGNOSYS_SEQ_ID"));
