/**
 * @ (#) PlanListAction.java   June 30, 2008
 * Project        : TTK HealthCare Services
 * File           : PlanListAction.java
...
public class PlanListAction extends TTKAction
{
	private static Logger log = Logger.getLogger( PlanListAction.class );

	//Action mapping forwards.
	private static final String strProductPlanList="planlist";
	private static final String strPolicyPlanList="policyplanlist";
	...
	public ActionForward  doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws Exception 
	{
		try
		{
			log.debug("Inside the doDefault method of PlanListAction");
			setLinks(request);
			String strTable = "";
			DynaActionForm frmPlanList =(DynaActionForm)form;
			...
			if("Products".equals(strActiveSubLink)){
				...
				strForwardPath=strPolicyPlanList;
			}//end of else
			frmPlanList.set("caption",sbfCaption.toString());
			...
			alPlanList = productPolicyConfig.getPlanList(tableData.getSearchData());
			tableData.setData(alPlanList,"search");
			request.getSession().setAttribute("tableData",tableData);
			request.setAttribute("frmPlanList",frmPlanList);
	...
	public ActionForward doBackward(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			log.debug("Inside the doBackward method of PlanListAction");
			setLinks(request);
			String strForwardPath=null;
			String strActiveSubLink=TTKCommon.getActiveSubLink(request);
			ProdPolicyConfigManager  productPolicyConfig= null;
			...
			ArrayList alPlanList = productPolicyConfig.getPlanList(tableData.getSearchData());
	...
	public ActionForward doForward(ActionMapping mapping,ActionForm form,HttpServletRequest request,
													 HttpServletResponse response) throws TTKException{
		try{
			log.debug("Inside the doForward method of PlanListAction");
			setLinks(request);
			String strForwardPath=null;
			String strActiveSubLink=TTKCommon.getActiveSubLink(request);
			ProdPolicyConfigManager  productPolicyConfig= null;
