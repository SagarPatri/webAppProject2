...
{
    document.forms[1].mode.value="doViewCriticalGroups";
...
{
	document.forms[1].mode.value="doViewCriticalProcedureList";
	document.forms[1].rownum.value=rownum;
	document.forms[1].action="/CriticalProcedureListAction.do";
	document.forms[1].submit();
}//end of onHistoryIcon(rownum)

//onCriticalHistoryIcon

function onHospitalIcon(rownum)
{
	document.forms[1].mode.value="doViewCriticalICDList";
	document.forms[1].rownum.value=rownum;
