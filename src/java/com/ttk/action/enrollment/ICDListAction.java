...
import com.ttk.action.preauth.PackageListAction;
...
public class ICDListAction extends TTKAction {
    ...
    private static final String strCodePreauthICDList="codepreauthicdlist";
    private static final String strCodeClaimsICDList="codeclaimsicdlist";
    private static final String strCodePreauthMedical="codepreauthmedical";
    private static final String strCodeClaimsMedical="codeclaimsmedical";
    ...
    private static final String strCodeClaimsPedDetail="codeclaimspeddetail";
    ...
    public ActionForward doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
            ...
            if(strActiveLink.equals(strPreAuthorization)||strActiveLink.equals(strClaims)||strActiveLink.equals("Coding")||strActiveLink.equals("Code CleanUp"))
            {
    ...
    public ActionForward doSelectICD(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		...
    		if(!(TTKCommon.checkNull(request.getParameter("rownum")).equals("")))
            {
                ...
                else if(strActiveLink.equals(strPreAuthorization) ||strActiveLink.equals(strClaims))
                {
                ...
                }//end of else if(strActiveLink.equals(strPreAuthorization) ||strActiveLink.equals(strClaims))
                else if(strActiveLink.equals("Coding")||strActiveLink.equals("Code CleanUp"))
                {
                	if(strFlag.equals(strICDPCS))   //Preauth/Claims -->ICDPCS flow
                    {
                		...
                		if(strActiveSubLink.equals("Claims"))
                		{
                			...
                			if(diagSeqId!="")
                			{
                				diagnosisSeqID = new Long(diagSeqId);
                			}                			
                		}
	...
	private String getICDListPath(HttpServletRequest request)throws TTKException
	{
		...
		try
        {
	        ...
	        else if(strActiveLink.equals("Coding"))
			{
