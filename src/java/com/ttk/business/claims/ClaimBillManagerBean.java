...
import com.ttk.dao.impl.claims.ClaimBillDAOImpl;
...
public class ClaimBillManagerBean implements ClaimBillManager {
    ...
    public String getAccountType(long lngClaimSeqID) throws TTKException{
    	claimBillDAO = (ClaimBillDAOImpl)this.getClaimBillDAO("bill");
    	return claimBillDAO.getAccountType(lngClaimSeqID);
    }//end of strGetBillLineitemList(long lngClaimSeqID,long lngUserSeqID)
