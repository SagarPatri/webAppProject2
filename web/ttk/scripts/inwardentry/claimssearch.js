//javascript used in claimsearch.jsp of Inward Entry flow
...
//function to sort based on the link selected
	function toggle(sortid)
	{
	    ...
	    document.forms[1].action = "/InwardClaimsAction.do";
	...
	function edit(rownum)
	{
	    ...
	    document.forms[1].tab.value="Claim Details";
	...
	function onDelete()
	{
   		 if(!mChkboxValidation(document.forms[1]))
    	{
			...
			if(msg)
			{
				...
				document.forms[1].action = "/DeleteInwardClaimsAction.do";
				document.forms[1].submit();
			}// end of if(msg)
