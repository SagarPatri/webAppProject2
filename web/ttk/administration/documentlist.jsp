...
<script language="javascript" src="/ttk/scripts/administration/documentlist.js"></script>
<%
...
<fieldset>
	...
	<div class="scrollableGrid" style="height:350px;">
	  <table class="gridWithCheckBox zeroMargin" border="0" cellspacing="0" cellpadding="0"  align="center" style="margin-left:7px; width:97%;">
	  <logic:notEmpty name="alFileList">
	   <tr>
          <td width="98%" nowrap class="gridHeader">Document Name</td>          
