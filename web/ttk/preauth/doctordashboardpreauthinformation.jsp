...
<html:form action="/PreDoctorDashboardPreauthDetails.do" >
 <html:errors/> 
<div id="dashboadCollapse" data-children=".item" class="vd-dash-collapse ">
				...
				<div id="dCollapseItem" class="collapse show" role="tabpanel">
					<div class="">
						...
						<div class="action-elements clr-error">
								...
								<span style="text-decoration: none;cursor: default;"><bean:write name="frmDashboardList" property="coding_cases"/>/
								<span id="spanhvp" title="Cases over approval limit" style="text-decoration: none;cursor: default;">
								...
								<div class="info-icon">
									<a href="#" data-toggle="tooltip" data-placement="Bottom"
										title="Displays Fresh cases"><img
										src="/ttk/images/info_icon.svg"
										title="info_icon" alt="info_icon">
									</a>
								</div>
							...
							<div class="action-elements clr-success">
								...
								<div class="info-icon">
									<a href="#" data-toggle="tooltip" data-placement="Bottom"
										title="Displays Logged In Doctors cases"><img
										src="/ttk/images/info_icon.svg"
										title="info_icon" alt="info_icon">
									</a>
								</div>
		...
		<!-- S T A R T : Grid -->
		<div class="vd-page-body-tile">Pre-Auth Cases Information</div>
	    <ttk:HtmlGrid1 name="tableDataTeamDashbord" />
    	<!-- E N D : Grid -->
</div>
</body>
