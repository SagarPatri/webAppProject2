...
<script language="javascript" src="/ttk/scripts/onlineforms/empanelment/provideroveralinfrastructure.js"></script>
...
<%
	...
	%>
<!-- S T A R T : Header -->
	<html:form action="/SaveOverAllInfraStrAction.do" >
