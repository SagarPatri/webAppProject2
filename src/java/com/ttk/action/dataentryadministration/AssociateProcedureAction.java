...
package com.ttk.action.dataentryadministration;
...
public class AssociateProcedureAction extends TTKAction
{
	...
	private static final String strCodeClaimsAssociates="dataentrycodeclaimsassociates";
	...
	public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			...
			ParallelTariffManager tariffPlanObject=this.getTariffPlanManagerObject();
	 ...
	 */
	private ParallelTariffManager getTariffPlanManagerObject() throws TTKException
	{
		ParallelTariffManager tariffPlanManager = null;
		try
		{
			if(tariffPlanManager == null)
			{
				InitialContext ctx = new InitialContext();
				tariffPlanManager = (ParallelTariffManager) ctx.lookup("java:global/TTKServices/business.ejb3/ParallelTariffManagerBean!com.ttk.business.dataentryadministration.ParallelTariffManager");
			}//end if
		}//end of try
		catch(Exception exp)
		{
	...
	private String getAsscProcedureCode(HttpServletRequest request) throws TTKException
	{
		try
		{
			...
			else if(strLink.equals("Coding")||strLink.equals("Code CleanUp")||strLink.equals("DataEntryCoding"))
			{
