...
/**
  * @ (#) InvestigatReportsAction.java April 24, 2008
  * Project      : TTK HealthCare Services
  * File         : InvestigatReportsAction.java
  * Author       : Ajay Kumar
...
public class InvestigationReportsAction extends TTKAction {
	private static final Logger log=Logger.getLogger(InvestigationReportsAction.class);
    ...
    private static final String strReportdisplay="reportdisplay";
	 ...
	 /**
	    ...
	    public ActionForward doChangeInsCompany(ActionMapping mapping,ActionForm form,HttpServletRequest request,
			 ...
			 try{
				 log.debug("Inside the doChangeInsCompany method of InvestigationReportsAction");
				 setLinks(request);
	    ...
	    public ActionForward doChangeInsComDoBo(ActionMapping mapping,ActionForm form,HttpServletRequest request,
	    										HttpServletResponse response) throws TTKException{
			 try{
				 log.debug("Inside the doChangeInsComDoBo method of InvestigationReportsAction");
				 setLinks(request);
				 DynaActionForm frmTtkReports = (DynaActionForm) form;
		...
		public ActionForward doChangeLabel(ActionMapping mapping,ActionForm form,HttpServletRequest request,
										   HttpServletResponse response) throws TTKException{
			try{
				log.debug("Inside the doChangeLabel method of InvestigationReportsAction");
				setLinks(request);
		...
		public ActionForward doChangeStatus(ActionMapping mapping,ActionForm form,HttpServletRequest request,
				                            HttpServletResponse response) throws TTKException{
			try{
				log.debug("Inside the doChangeStatus method of InvestigationReportsAction");
				setLinks(request);
				DynaActionForm frmStatusReports = (DynaActionForm) form;
				frmStatusReports.set("frmChanged", "changed");
				return this.getForward(strInvestigationMonitorReport,mapping,request);
			}//end of try
			catch(TTKException expTTK)
			{
	    ...
	    public ActionForward doGenerateReport(ActionMapping mapping,ActionForm form,HttpServletRequest request,
	            							  HttpServletResponse response) throws TTKException{
	    	try{
	    		log.debug("Inside the doGenerateReport method of InvestigationReportsAction");
	    		setLinks(request);
	    		...
	    		log.info("Inside the doGenerateReport method of InvestigationReportsAction strParam=== " +strParam);
	    		...
	    		reportDetailVO.setInvestAgencyName(request.getParameter("investAgencyna"));
				reportDetailVO.setEnrolmentId(request.getParameter("sEnrolmentId"));
	    		reportDetailVO.setCorInsurer(request.getParameter("sCorInsurer"));	    		
	    		//call the DAO to save the Report parameter details
				
	    		int iCount=reportDetailObject.saveReportDetails(reportDetailVO); 
	    		if(iCount>=0)
				{
	    			log.info("Inside the doGenerateReport method of InvestigationReportsAction in iCount");
	    		...
	    		try
	    		{
	    			...
	    			hashMap.put("investAgencyna",request.getParameter("investAgencyna"));
					...
					hashMap.put("sEnrolmentId",request.getParameter("sEnrolmentId"));
	    			hashMap.put("sCorInsurer",request.getParameter("sCorInsurer"));
    ...
    /**
	 ...
	 public ActionForward doClose(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws TTKException{
		 try{
			 setLinks(request);
			 log.debug("Inside the doClose method of InvestigationReportsAction");
...
}//end of public class InvestigationReportsAction extends TTKAction
