...
<script language="javascript" src="/ttk/scripts/maintenance/pharmacyMasterSearch.js"></script>
<!-- S T A R T : Content/Form Area -->
<html:form action="/MaintainPharmacySearchAction.do" >
	<!-- S T A R T : Page Title -->
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
  	<tr>
    	<td>Pharmacy Master Search</td>
    </tr>	
	</table>
	<!-- E N D : Page Title --> 
	...
	<fieldset>
	<legend>Pharmacy Master Search</legend>
