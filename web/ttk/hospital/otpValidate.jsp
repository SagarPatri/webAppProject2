...
<%} %>
	...
	<!-- S T A R T : Form Fields -->
	    ...
	    <p> 
			...
			<strong><bean:write name="frmCashlessAdd" property="eligibility"/> </strong></label></h3>
...
<br>
		...
		<table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr>
			        ...
			        <td width="30%">:&nbsp;<bean:write name="frmCashlessAdd" property="memberStartDate"/> </td>
			         <td width="15%" class="formLabel"><strong>Member End Date</strong></td>
			        <td width="30%">:&nbsp;<bean:write name="frmCashlessAdd" property="memberEndDate"/></td>
		        </tr>
		</table>        
		</fieldset> <br>
		</logic:equal>
		...
		<table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0">
		    	<tr>
			        ...
			        <td width="30%">:&nbsp;<bean:write name="frmCashlessAdd" property="initPolicyNo"/> </td>
		      	</tr>
		      	<tr>
			        <td width="15%" class="formLabel" ><strong>Policy Start Date.</strong></td>
			        <td width="30%">:&nbsp;<bean:write name="frmCashlessAdd" property="policyStDt"/> </td>
		...
		<table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0">
		        <tr>
			        ...
			        <td width="30%">:&nbsp;<bean:write name="frmCashlessAdd" property="renewedMemberStartDate"/> </td>
			         <td width="15%" class="formLabel"><strong>Renewed Member End Date</strong></td>
			        <td width="30%">:&nbsp;<bean:write name="frmCashlessAdd" property="renewedMemberEndDate"/></td>
		        </tr>
		</table>        
		</fieldset>
...
<input type="hidden" name="eligibilityFlag" value="<bean:write name="frmCashlessAdd" property="eligibility"/>">
<input type="hidden" name="benefitType" value="<bean:write name="benefitText" scope="session"/>">
<input type="hidden" name="bufferWarningFlag" value="<bean:write name="frmCashlessAdd" property="bufferWarning"/>">
