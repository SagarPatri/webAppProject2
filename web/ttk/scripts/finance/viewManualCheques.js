...
function edit(rownum)
{
		...
		document.forms[1].action = "/ViewManualChequePrintingsAction.do";
		...
		//var openPage = "/ViewManualChequePrintingsAction.do?mode=doViewFile";
		var openPage = "/ViewManualChequePrintingsAction.do?mode=doViewFile&rownum="+rownum;
