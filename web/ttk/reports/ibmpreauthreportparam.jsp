...
<script language="javascript" src="/ttk/scripts/reports/ibmpreauthreportparam.js"></script>
		...
		<legend>Report Parameters </legend>
			<table border="0" align="center" cellpadding="0" cellspacing="0" class="formContainer">
				...
				<td nowrap>Status. <span class="mandatorySymbol">*</span></td>
					<td>
						<html:select property="policyPreauthID"  styleClass="selectBox selectBoxMedium">
							<html:option value="">Select from list</html:option>
	...
	<table align="center" class="buttonsContainer" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100%" align="center">Report Type 
				...
				<button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'"	onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGeneratePreauthReport();"><u>G</u>enerateReport</button>
				&nbsp;
