...
function edit(rownum)
{
    ...
    document.forms[1].action = "/SaveMemRulesAction.do";
...
{
	document.forms[1].mode.value="doCloseMemberRuleHistory";
...
<html:form action="/SaveMemRulesAction.do">

<!-- S T A R T : Page Title -->
<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
  <tr>
     <td>Member Policy Rules History List<%-- - <bean:write name="frmRules" property="caption"/> --%></td>
