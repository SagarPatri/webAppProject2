...
<script type="text/javascript" >
		...
		{
			var e = document.getElementById("overrideGenRemarks");
			var overrideGenRemarks = e.value;
		//	alert(overrideGenRemarks);

			/*  popupWindow=window.open("/ClaimGeneralOverrideAction.do?mode=getOverrideGenSubRemarks"+"&overrideGenRemarks="+overrideGenRemarks,"Claim","toolbar=no,scrollbars=yes,status=no,menubar=0,width=450,height=250");
		     document.onmousedown=focusPopup; 
			 document.onkeyup=focusPopup; 
			 document.onmousemove=focusPopup; */
			document.forms[0].action="/ClaimGeneralOverrideAction.do?mode=getOverrideGenSubRemarks"+"&overrideGenRemarks="+overrideGenRemarks;
		...
		function saveGenOverrideRemarks()
		{
		    ...
		    //parent.window.opener.document.getElementById("overrideRemarks").value=overrideGenOtherRemarks;	
			window.close();
			window.opener.document.forms[1].mode.value="overridClaimDetails"; 
			window.opener.document.forms[1].action="/ClaimGeneralAction.do?overrideGenRemarks="+overrideGenRemarks+"&overrideGenSubRemarks="+overrideGenSubRemarks;
...
<body>
	...
	<html:form action="/ClaimGeneralOverrideAction.do">
	<table>
	...
	<logic:equal name="frmClaimGeneral"  property="overrideGenRemarks"  value="PREA">
		<tr style="height: 40px;">
	...
	<logic:equal name="frmClaimGeneral"  property="overrideGenRemarks"  value="RPAC">
		<tr style="height: 40px;">
			<td>Override Sub Remarks:<span class="mandatorySymbol">*</span></td>
			<td>
				<html:select property="overrideGenSubRemarks" styleId="overrideGenSubRemarks" >
