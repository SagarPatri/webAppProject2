...
<td nowrap>Treatment Start date:<span class="mandatorySymbol">*</span><br>
  ...
  <html:text name="frmPBMReportsList" property="tmtfromDate" maxlength="10" styleClass="textBoxDate"/>
  ...
  <html:text name="frmPBMReportsList" property="tmttoDate" maxlength="10" styleClass="textBoxDate"/>
  <a NAME="CalendarObjectPARDate" ID="CalendarObjectPARDate"
												HREF="#"
 ...
 <tr>
	  ...
	  <html:text property="invoiceNo" name="frmPBMReportsList" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  ...
	  <html:text property="claimNo" name="frmPBMReportsList" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  </tr>
	  <tr>
	  ...
	  <html:text property="qatarId" name="frmPBMReportsList" styleClass="textBox textBoxMedLarge"/>
	  </td>
	  
	  <td nowrap>Payment Reference Number:<br>
	  <html:text property="payRefNo" name="frmPBMReportsList" styleClass="textBox textBoxMedLarge"/>
