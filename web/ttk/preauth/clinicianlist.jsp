...
<script type="text/javascript" src="/ttk/scripts/preauth/clinicianlist.js"></script>
...
<html:form action="/ClinicianAction.do">
	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
      ...
      <td nowrap>Provider Id:<br>        
		...
		<td valign="bottom" nowrap>
			<a href="#" accesskey="s" onClick="javascript:clinicianSearch(this)"   class="search"><img src="/ttk/images/SearchIcon.gif" title="Search" width="16" height="16" border="0" align="absmiddle">&nbsp;<u>S</u>earch</a></td>
        <td width="100%">&nbsp;</td>
      </tr>
     </table>
	<!-- E N D : Search Box -->
