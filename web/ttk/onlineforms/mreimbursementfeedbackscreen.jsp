 ...
 * File         : mreimbursementfeedbackscreen.jsp
 * Author       : Manohar
 * Company      : RCS
...
<script language="JavaScript" src="/ttk/scripts/onlineforms/mreimbursementfeedbackscreen.js"></script>
<%
	UserSecurityProfile userSecurityProfile=(UserSecurityProfile)request.getSession().getAttribute("UserSecurityProfile");
%>
<body onLoad="document.forms[1].elements['sAdmissionDate'].focus();">
<html:form action="/ChangeMReimbursementFBAction.do" method="post">
<!-- S T A R T : Page Title -->
        <table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>Member Reimbursement Feedback Screen
              </td>
            </tr>
        </table>
	<!-- E N D : Page Title -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%; background-color:#FFFFFF;">
  		...
  		<tr><td class="formLabel" align="center"><b>Vidal Healthcare Services Pvt Ltd</b></td></tr>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td class="formLabel" align="center"><b>MEMBER REIMBURSEMENT CLAIM</b></td></tr>
		</table>
		<fieldset>
	...
	<logic:iterate id="FeedbackMReimbursementVO" name="frmChangeMReimbursementFBAction" property="alQuestionList" indexId="index">
	<fieldset>
	<legend><bean:write name="FeedbackMReimbursementVO" property="questionName"/></legend>
	<table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0">
	<logic:iterate id="FeedbackMReimbursementVO" name="FeedbackMReimbursementVO"  property="feedBack" indexId="index1">
	<tr>
	<td>
	<html:radio  property="<%=\"alQuestionList[\"+index+\"]\"%>" value="answerSeqID" idName="FeedbackMReimbursementVO"/>
	<bean:write name="FeedbackMReimbursementVO" property="answerName" />
	</td>
	</tr>
	</logic:iterate>	
	</table>
	...
	<tr>
        <td class="formLabel" height="25">Remarks: </td>
            <td colspan="1" nowrap="nowrap">
              <textarea name="remarks" class="textBox textAreaLong"></textarea>
            </td>
      </tr>
	</table>
    </fieldset> 
	...
	<tr>
        <td class="formLabel" height="25">Remarks: </td>
            <td colspan="1" nowrap="nowrap">
              <textarea name="remarks1" class="textBox textAreaLong"></textarea>
            </td>          
      </tr>
	</table>
    </fieldset>
