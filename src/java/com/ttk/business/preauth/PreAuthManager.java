...
public interface PreAuthManager {
    ...
    public ActivityDetailsVO getActivityCodeTariff(String activityCode,String preAuthSeqID,String activityStartDate,String authType, String benefitTyperef,String searchType) throws TTKException;
  ...
  public HashMap<String,String> getProviders() throws TTKException;
   ...
   public ArrayList<ReportVO> getDownloadHistoryDetailsPATCLM(String strhistorymode, Long long1)throws TTKException;
