 ...
 * @ (#) OnlinePtnrClaimDashBoard.java 
 * Project      : TTK HealthCare Services
 * File         : OnlinePtnrClaimDashBoard.java
 *  Author       :
 * Company      : 
 * Date Created : 
 *
 ...
 */
public class OnlinePtnrClaimDashBoard extends TagSupport{
    ...
    private static Logger log = Logger.getLogger( OnlinePtnrClaimDashBoard.class );
	...
	public int doStartTag() throws JspException{
		...
		{			
			...
			docClaims= (((Document)pageContext.getSession().getAttribute("onlineptnrhomeclaim"))!=null) 
					   ? (Document)pageContext.getSession().getAttribute("onlineptnrhomeclaim")
					   : (Document)onlineAccessManagerObject.getPartnerDashBoard(userSecurityProfile.getPtnrSeqId(),null,null,"Claims");
						
	        pageContext.getSession().setAttribute("onlineptnrhomeclaim",docClaims);
		
			
			out.print("<table width=\"75%\" align=\"center\"  border=\"0\" cellspacing=\"0\" cellpadding=\"5\">");

	        	 
	 if(!((List)docClaims.selectNodes("//Partner//claims")).isEmpty())		{
	    	
	                List claimList=	docClaims.selectNodes("//Partner//claims");
	              ...
	              //above if statement is commented B'coz, colums has to show even if the data is not exist as per the requirement from Shankar
					...
					out.print("</tr>");
					  ...
					  out.print("<tr>");
	      					...
	      					out.print("</td>");
	      					out.print("<td width=\"50%\" class=\"textLabelBold\" align=\"left\">");
	      						out.print((claimsNode.valueOf("@inprogress").equalsIgnoreCase(""))?0:claimsNode.valueOf("@inprogress"));
	      					out.print("</td>");
	      			out.print("</tr>");
