<%
/**
 * @ (#) editptnrfeedback.jsp 21st Sep 2005
 * Project      : TTK HealthCare Services
 * File         : editptnrfeedback.jsp
...
<script language="javascript" src="/ttk/scripts/empanelment/editptnrfeedback.js"></script>

	<!-- S T A R T : Content/Form Area -->
	<html:form action="/EditPtnrFeedbackAction" >
