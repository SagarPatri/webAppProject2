...
/**
 * @ (#) DHPOGlobalNetDownloadPreauth.java JAN 09 2017
 * Project      : TTK HealthCare Services
 * File         : DHPODownloadPreauth.java
 * Author       : Nagababu Kamadi
 * Company      : RCS TEchnologies
 * Date Created : JAN 09 2017
 *
 * @author       : Nagababu Kamadi
 * Modified by   :
 * Modified date :
...
public class DHPOGlobalNetDownloadPreauth implements Job {
	
	private static final String strDHPOGlobalNetDownloadPreauthError="DHPOGlobalNetDownloadPreauth";
	private static final Logger log = Logger.getLogger( DHPOGlobalNetDownloadPreauth.class );
	...
	public void execute(JobExecutionContext arg0) {	
		...
		if(new Boolean(TTKPropertiesReader.getPropertyValue("DHPO.GNPD.WS.RUN.MODE"))){
			
			log.info("DHPO Global Net Download Preauth Started..........");
			
			String strNewTransactionPath=	TTKPropertiesReader.getPropertyValue("path.dhpoGlobalnetPreauthDownload");
					...
					if("False".equalsIgnoreCase(node.valueOf("@IsDownloaded"))){
						...
						if(strFileContent.contains("Prior.Request") || strFileContent.contains("PriorRequest.xsd")){
							...
							if(downloadTransactionFileResult.value==1||downloadTransactionFileResult.value==0){
								...
								maintenanceManager.saveDhpoGlobalnetPreauthDownloadDetails(dhpoWebServiceVO);
							}
						}//if(strFileContent.contains("Prior.Request") || strFileContent.contains("PriorRequest.xsd")){
						}//if(fileContent!=null&&fileContent.value!=null){
						}//if(downloadTransactionFileResult!=null&&downloadTransactionFileResult.value!=null){
		...
		log.info("DHPO Global Net Download Preauth Ended..........");
			...
			new Exception(strDHPOGlobalNetDownloadPreauthError);
	...
	private MaintenanceManager getMaintenanceManagerObject() throws TTKException
	{
		...
		{
			throw new TTKException(exp, strDHPOGlobalNetDownloadPreauthError);
		}//end of catch
