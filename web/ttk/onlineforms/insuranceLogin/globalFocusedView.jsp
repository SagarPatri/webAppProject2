...
<script language="javascript" src="/ttk/scripts/onlineforms/insuranceLogin/globalFocusedView.js"></script>
...
<div class="span8">
<!-- <div id="navigateBar">Home > Corporate > Select Global / Focused View</div> -->
