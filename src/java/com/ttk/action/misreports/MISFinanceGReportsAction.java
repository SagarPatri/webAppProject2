...
/**
  * @ (#) MISFinanceGReportsAction.java
  * Project      : TTK HealthCare Services
  * File         : MISFinanceGReportsAction.java
  * Author       : Ajay Kumar
 ...
 */
public class MISFinanceGReportsAction extends TTKAction {

	private static final Logger log = Logger.getLogger( MISFinanceGReportsAction.class );
  ...
  public ActionForward doChangeInsCompany(ActionMapping mapping,ActionForm form,HttpServletRequest request,
			...
			try{
					log.debug("Inside the doChangeInsCompany method of MISFinanceGReportsAction");
					setLinks(request);
  ...
  public ActionForward doChangeInsComDoBo(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		  HttpServletResponse response) throws TTKException{
	  try{
		  log.debug("Inside the doChangeInsComDoBo method of MISFinanceGReportsAction");
		  setLinks(request);
		  DynaActionForm frmTtkReports = (DynaActionForm) form;
 ...
 public ActionForward doGenerateReport(ActionMapping mapping,ActionForm form,HttpServletRequest request,
         							  HttpServletResponse response) throws TTKException{
 	try{
 		log.debug("Inside the doGenerateReport method of MISFinanceGReportsAction");
 		setLinks(request);
 		...
 		if(iCount>=0)
			{
 			log.info("Inside the doGenerateReport method of MISFinanceGReportsAction in iCount");
...
}//end of MISFinanceGReportsAction
