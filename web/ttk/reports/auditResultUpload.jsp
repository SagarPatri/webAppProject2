...
<html:form action="/AuditReportAction.do" enctype="multipart/form-data" method="post">
   ...
   <tr>
      ...
      <tr>
        ...
        <td width="90%">
	        <html:select property="switchType" styleClass="specialDropDown" styleId="switchType" onchange="javascript:onSwitch()">
				...
				<html:option value="PRE">PREAUTH</html:option>
			</html:select>
		</td>
		</tr>
    </table> --%>
	<FIELDSET>
			...
			<table align="center"  class="gridWithPricing" border="0" cellspacing="1" cellpadding="0">
               ...
               <font color="color:#495879;">Show Template :</font><a href="#" onClick="javascript:showTemplate()" >Claim Audit Template</a>
      		   </td>
        	   </tr>
        	   <tr><td></td></tr>
        	   <tr><td><br/></td></tr>
        ...
        <td align="center" width="40%">
					<button type="button" name="Button" accesskey="g" class="buttons"
						...
						onClick="javascript:onUploadClaimAuditReport();">
						<u>U</u>pload File
					</button>&nbsp;
	...
	<!-- <table align="right" class="buttonsContainer" border="0"
			...
			<tr>
				<td width="100%" align="center">
					...
					<button type="button" name="Button" accesskey="c" class="buttons"
						onMouseout="this.className='buttons'"
						onMouseover="this.className='buttons buttonsHover'"
						onClick="javascript:onCloseUWindow()">
						<u>C</u>lose
					</button>
				</td>
			</tr>
