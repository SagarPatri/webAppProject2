...
function displayBenefitsBasedOnType(){
	...
	document.forms[1].action="/PreAuthGeneralAction.do?benefitType="+benefitType;	 
	document.forms[1].submit();
}
		...
		<fieldset>
		  ...
		  <tr>
		        <td class="formLabel">Alkoot ID:</td> 
					  <td class="textLabel">
					 <input type="text" class="textBox textBoxLarge textBoxDisabled" value="<bean:write name="frmPreAuthGeneral" scope="session" property="memberId" />">
			         
					  </td>
					  <td class="formLabel">Member Inception Date:</td>
					  <td class="textLabel">
					  	  <input type="text" class="textBox textBoxLarge textBoxDisabled" value="<bean:write name="frmPreAuthGeneral" scope="session" property="preMemInceptionDt" />">
					  </td>
					  </tr>
					  <tr>
					  <td class="formLabel">Policy No:</td>
					  <td class="textLabel">
				 		<input type="text" class="textBox textBoxLarge textBoxDisabled" value="<bean:write name="frmPreAuthGeneral" scope="session" property="policyNumber" />">
					  </td>
					  <td class="formLabel">Provider Networks:</td>
					  <td class="textLabel">
					  	 <input type="text" class="textBox textBoxLarge textBoxDisabled" value="<bean:write name="frmPreAuthGeneral" scope="session" property="eligibleNetworks" />">
					  </td>
					  </tr>
					  <tr>
					  <td class="formLabel">Policy start Date: </td>
					  <td class="textLabel">
			          <input type="text" class="textBox textBoxLarge textBoxDisabled" value="<bean:write name="frmPreAuthGeneral" scope="session" property="policyStartDate" />">
					  </td>
					   <td class="formLabel">Policy End Date:</td>
					  <td class="textLabel">
					  	 <input type="text" class="textBox textBoxLarge textBoxDisabled" value="<bean:write name="frmPreAuthGeneral" scope="session" property="policyEndDate" />">
					  </td>
		 </tr>
	   </table>	
					  </fieldset>
		  ...
		  <tr>
		        <td class="formLabel">Sum Insured:</td>
					  <td class="textLabel">
					 <input type="text" class="textBox textBoxLarge textBoxDisabled" value="<bean:write name="frmPreAuthGeneral" scope="session" property="sumInsured" />">
