	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<td valign="bottom" nowrap>
			<a href="#" accesskey="s" onClick="javascript:memberSearch(this)"   class="search"><img src="/ttk/images/SearchIcon.gif" title="Search" width="16" height="16" border="0" align="absmiddle">&nbsp;<u>S</u>earch</a></td>
        <td width="100%">&nbsp;</td>
      </tr>
     </table>
     <div>
