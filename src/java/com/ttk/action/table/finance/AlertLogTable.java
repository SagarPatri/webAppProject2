...
public class AlertLogTable extends Table{
...
//      Setting properties for Log Date
        ...
        colLogType.setMethodName("getLogType");
        ...
        Column internalCode = new Column("Modified Reason");
        internalCode.setMethodName("getModifiedReason");
...
//      Setting properties for Description
        ...
        colLogDescription.setMethodName("getRemark");
        colLogDescription.setSpecificLetterbold("alertLogRemarks");
