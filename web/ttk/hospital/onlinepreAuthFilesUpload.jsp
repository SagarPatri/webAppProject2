<%
/**
 * @ (#) onlinepreAuthFilesUpload.java 31 Dec 2014
 * Project      : TTK HealthCare Services
 * File         :onlinepreAuthFilesUpload.java
...
%>
<html:form action="/UploadMOUCertificatesSaveList.do"  method="post" enctype="multipart/form-data">
	<!-- S T A R T : Page Title -->
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
		<tr>
    		<td>Upload Attachments- <bean:write name="frmOnlinePreAuthFileUpload" property="caption"/></td>   
    		</tr>
	</table>
	<html:errors/>
	<!-- E N D : Page Title --> 
