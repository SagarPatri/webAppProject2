...
/* var  claimType=document.getElementById('claimType').value;
 var  bufferType=document.getElementById('bufferType').value;
 var  bufferType1=document.getElementById('bufferType1').value;
 var  hrapproval=document.getElementById('hrapproval').value;
  ...
  */
  if(document.forms[1].documentType.value == "SRT")
    ...
    {
    	/*document.forms[1].claimType.value=claimType;
    	document.forms[1].bufferType.value=bufferType;
    	*/
        document.forms[1].mode.value="doView";
...
function onCancel()
{
	if(!TrackChanges()) return false;
 	document.forms[1].mode.value="doCloseInv";
...
function onAddClick()
{
	var obj=document.getElementById['documentType'];
		document.forms[1].mode.value="doAdd";
        document.forms[1].child.value="Add";
        document.forms[1].action = "/InvestigationAction.do";
    //end of if(document.forms[1].documentType.value == "SRT")    
