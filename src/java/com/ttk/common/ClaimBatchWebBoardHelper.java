/**
 * @ (#) PreAuthWebBoardHelper.javaMay 15, 2006
 ...
 *
 */
public class ClaimBatchWebBoardHelper
{
    private static Logger log = Logger.getLogger( ClaimBatchWebBoardHelper.class );
   ...
   public static String checkWebBoardId(HttpServletRequest request)throws TTKException
   {
	   ...
	   ClaimBatchWebBoardHelper.setWebBoardId(request);
    ...
    * @throws TTKException
    */
   public static Long getBatchSeqId(HttpServletRequest request)throws TTKException
   {
       log.debug("inside...... getBatchSeqId....");
       Toolbar toolbar = (Toolbar) request.getSession().getAttribute("toolbar");
       String strCacheId = "";
       ...
       return null;
   }//end of getBatchSeqId(HttpServletRequest request)
...
}// end of ClaimBatchWebBoardHelper