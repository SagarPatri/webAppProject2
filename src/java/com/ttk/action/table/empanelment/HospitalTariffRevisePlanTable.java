/**
 * @ (#) HospitalTariffRevisePlanTable.java Oct 22, 2005
 * Project      : TTK HealthCare Services
 * File         : HospitalTariffRevisePlanTable.java
 ...
 */
public class HospitalTariffRevisePlanTable extends Table {
	...
	public void setTableProperties() {
		...
		columnPlanName.setIsLink(true);                          // Is this column data contains  the hyperlink
		columnPlanName.setLinkTitle("Plan Name");                // Set the link title
