//This file contains javascript functions for companysummary.jsp
...
{
	document.forms[1].mode.value ="doViewCompanyDetail";
	document.forms[1].child.value="Add/Edit Insurance Company";
...
{
	document.forms[1].mode.value ="doViewMailNotificationDetails";
	document.forms[1].flow.value="mailnotification";
	document.forms[1].action = "/CompanyDetailAction.do";
	document.forms[1].selectedroot.value=strRootIndex;	
	document.forms[1].submit();     
...
function onRootHospitalIcon(strRootIndex)
{
	document.forms[1].mode.value ="doViewHospitalList";
	document.forms[1].child.value="Hospital";
	document.forms[1].flow.value="hospitallist";
	document.forms[1].action = "/CompanyDetailAction.do";
	document.forms[1].selectedroot.value=strRootIndex;
	document.forms[1].submit();
}//end of onRootContactsIcon(strRootIndex)
