...
<html:form action="/TariffUploadsEmpanelmentAction.do" method="post" enctype="multipart/form-data">
	...
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
		  <tr>
		   <td>Pharmacy/Consumables Tariff Upload</td>
	...
	<!-- S T A R T : SELCTIONS -->
	<fieldset><legend>Pharmacy/Consumables Tariff Upload</legend>
	<table class="formContainer" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
       	<td  colspan="2" align="center">
	<button type="button" name="uploadButton" accesskey="u" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onUploadPharmacyTariff()"><u>U</u>pload Tariff</button>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div>
    <p> Click on <a href="#" onclick="javascript:pharmacyTariffUploadFormat()">Download</a> for Pharmacy/Consumables tariff upload format.</p>
