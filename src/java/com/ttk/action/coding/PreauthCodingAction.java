...
public class PreauthCodingAction extends TTKAction
{
	...
	private static final String strSaveCodeClaimsIcdPcs = "savecodeclaimsicdpcs";
	...
	private static final String strCodePreauthIcdPcsCoding = "codepreauthicdpcs";
	private static final String strCodeClaimsIcdPcsCoding ="codeclaimsicdpcs";
	private static final String strCodingAssociate="codingassociate";
	...
	public ActionForward doView(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try
		{
			...
			String strLink = TTKCommon.getActiveLink(request);
			String strSubLink = TTKCommon.getActiveSubLink(request);
			PreAuthManager PreAuthManagerObject=this.getPreAuthManager();
			CodingManager codingManager = this.getCodingManagerObject();
