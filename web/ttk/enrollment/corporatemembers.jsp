...
<%  policy_status =(String)request.getSession().getAttribute("policy_status");
    pageContext.getSession().setAttribute("policy_status","FTS");
...
<logic:empty name="frmMember" property="display">
	...
	<!-- E N D : Page Title -->
	<div width="105%"class="contentArea" id="contentArea">
     ...
     <table  align="center" class="searchContainer rcContainer" border="0" cellspacing="0" cellpadding="0">
      <tr>
       ...
       <logic:equal name="strSublink" value="Corporate Policy" >
        ...
        <td><a href="#" onClick="javascript:softcopyUpload()" >Softcopy Bulk Member Upload</a></td>
	...
	<table align="center" class="formContainer rcContainer" border="0" cellspacing="1" cellpadding="0">
	  ...
	  <tr>
		<td align="right" colspan="2" class="buttonsContainerGrid">
			...
			%>
			<%
	    		if(WebBoardHelper.getPolicySeqId(request)!=null && TTKCommon.isAuthorized(request,"Add"))
				{
		     %>
				     <button type="button" name="Button" accesskey="a" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addNewEnrollment();"><u>A</u>dd New Member</button>&nbsp;
			<%
				}//end of if(WebBoardHelper.getPolicySeqId(request)!=null&& TTKCommon.isAuthorized(request,"Add"))
