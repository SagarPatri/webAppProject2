/**
* @ (#) ClaimsSearchAction.java Aug 29,2007
...
{
	private static Logger log = Logger.getLogger(ClaimsSearchAction.class);
	...
	private static final  String strClaimslist="dataentryclaimsSearch";
	private static final  String strClaimDetail="dataentryclaimsdetail";
    ...
    public ActionForward doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		log.info("Inside the doDefault method of ClaimsSearchAction");
    		setLinks(request);
			...
			tableData.createTableInfo("CodingClaimsTable",new ArrayList());
    ...
    public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    												HttpServletResponse response) throws Exception{
    	try{
    		log.info("Inside the doSearch method of DataEntryClaimsSearchAction");
    		setLinks(request);
    		ParallelCodingManager codingManagerObject=this.getCodingManagerObject();
    		//get the tbale data from session if exists
			TableData tableData =TTKCommon.getTableData(request);
			...
			{
				//create the required grid table
				tableData.createTableInfo("CodingClaimsTable",null);
				tableData.setSearchData(this.populateSearchCriteria((DynaActionForm)form,request));
                this.setColumnVisiblity(tableData,(DynaActionForm)form,request);
				tableData.modifySearchData("search");
			}//end of else
			ArrayList alClaimsList= codingManagerObject.getClaimList(tableData.getSearchData());
    ...
    public ActionForward doBackward(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    										HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doBackward method of ClaimsSearchAction");
    		setLinks(request);
    		ParallelCodingManager codingManagerObject=this.getCodingManagerObject();
    		//get the tbale data from session if exists
			TableData tableData =TTKCommon.getTableData(request);
    ...
    public ActionForward doForward(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    													HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doForward method of ClaimsSearchAction");
    		setLinks(request);
    		ParallelCodingManager codingManagerObject=this.getCodingManagerObject();
    		//get the tbale data from session if exists
			TableData tableData =TTKCommon.getTableData(request);
    ...
    public ActionForward doCopyToWebBoard(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    													HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doCopyToWebBoard method of ClaimsSearchAction");
    		setLinks(request);
    ...
    public ActionForward doView(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    												HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doView method of ClaimsSearchAction");
    		setLinks(request);
    		//get the tbale data from session if exists
			TableData tableData =TTKCommon.getTableData(request);
     ...
     */
    private ArrayList<Object> populateSearchCriteria(DynaActionForm frmCodingClaimsList,HttpServletRequest request)
    {
    	//build the column names along with their values to be searched
    	ArrayList<Object> alSearchParams = new ArrayList<Object>();
    	alSearchParams.add(TTKCommon.replaceSingleQots((String)frmCodingClaimsList.getString("sClaimNumber")));
    	alSearchParams.add(TTKCommon.replaceSingleQots((String)frmCodingClaimsList.getString("sEnrollmentId")));
    	alSearchParams.add((String)frmCodingClaimsList.getString("sAssignedTo"));
    	alSearchParams.add((String)frmCodingClaimsList.getString("sTtkBranch"));
    	alSearchParams.add((String)frmCodingClaimsList.getString("sinceWhen"));
