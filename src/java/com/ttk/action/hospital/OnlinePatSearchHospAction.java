 ...
 */
public class OnlinePatSearchHospAction extends TTKAction {

	private static final Logger log = Logger.getLogger( OnlinePatSearchHospAction.class );
	...
	private static final String strOnlinePatList="onlinepatlist";  
	...
	public ActionForward doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			...
			return this.getForward(strOnlinePatList, mapping, request);
		}//end of try
		...
		try{
			...
			if(!strPageID.equals("") || !strSortID.equals(""))
			{
				if(!strPageID.equals(""))
				{
					...
					return (mapping.findForward(strOnlinePatList));
    ...
    public ActionForward doDashBoardDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,
                                                     HttpServletResponse response) throws Exception{
        try{
            log.info("Inside the doDashBoardDefault method of OnlinePatSearchHospAction");
            setOnlineLinks(request);
            
            return this.getForward("preauthdashboard", mapping, request);//preauthdashboard
        }//end of try
        catch(TTKException expTTK)
        {
            return this.processOnlineExceptions(request, mapping, expTTK);
	...
	/* public ActionForward doPreauthDashBoardData(ActionMapping mapping,ActionForm form,HttpServletRequest request,
			...
			//	tableData=(TableData)request.getSession().getAttribute("tableData");
				...
				Document docClaims=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,"Claims");
				Document docPreauth=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,"Preauth");
				...
				//set the table data object to session
				//finally return to the grid screen
				return mapping.findForward("hospitalhome");
