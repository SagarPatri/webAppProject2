...
import com.ttk.dao.impl.empanelment.PartnerDAOImpl;
...
public class PartnerManagerBean implements PartnerManager {

	private EmpanelmentDAOFactory empanelmentDAOFactory = null;
	private PartnerDAOImpl partnerDAO = null;
	...
	{
		partnerDAO = (PartnerDAOImpl)this.getEmpanelmentDAO("partner");
		return partnerDAO.getPartnerList(alSearchObjects);
	}//end of getHospitalList(ArrayList alSearchObjects)
    

    public HashMap getCityInfo() throws TTKException {
    	partnerDAO = (PartnerDAOImpl)this.getEmpanelmentDAO("partner");
    	return partnerDAO.getCityInfo();
    }//end of getCityInfo()
...
/**
    ...
    public HashMap getCityInfo(String stateCode) throws TTKException {
    	partnerDAO = (PartnerDAOImpl)this.getEmpanelmentDAO("partner");
    	return partnerDAO.getCityInfo(stateCode);
...
/**
	...
	{
		partnerDAO = (PartnerDAOImpl)this.getEmpanelmentDAO("partner");
		return partnerDAO.addUpdatePartner(partnerDetailVO);
	}//end of addUpdatePartner(PartnerDetailVO hospitalDetailVO)
		...
		public PartnerDetailVO getPartnerDetail(Long lPtnrSeqId) throws TTKException{
			partnerDAO = (PartnerDAOImpl)this.getEmpanelmentDAO("partner");
			return partnerDAO.getPartnerDetail(lPtnrSeqId);
...
*//**
    ...
    public ArrayList getStateInfo(String countryId) throws TTKException {
    	partnerDAO = (PartnerDAOImpl)this.getEmpanelmentDAO("partner");
    	return partnerDAO.getStateInfo(countryId);
    }//end of getStateInfo()
