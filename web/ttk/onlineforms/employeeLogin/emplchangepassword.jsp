...
function onChangePassword()
{
	if(!JS_SecondSubmit)
	{
		...
		document.forms[1].action = "/newSaveEmployeeChangePassword.do";
	...
	<table align="center" class="buttonsContainer"  border="0" cellspacing="0" cellpadding="0">
	  	<tr>
		    ...
		    <%
			    ...
			    {
			%>
	    			<button type="button" name="Button" accesskey="c" class="button_design_class" onMouseout="this.className='button_design_class'" onMouseover="this.className='button_design_class buttonsHover'" onClick="javascript:onChangePassword()"><u>C</u>hange Password</button>&nbsp;
		    </td>
		    <%
		    	}// end of if(TTKCommon.isAuthorized(request,"Edit"))
			 %>
...
<ul style="list-style-type:square">
  <li>Please give atleast one- Uppercase, Lowercase, Numeric, Special Character !@#$%^&*(){}[].</li>
  <li>New password should not be less than 8 characters and should not be longer than 16 characters.</li>
</ul>
</div>
<br/>
</div>
