...
<form action="/PreAuthGeneralAction.do" onsubmit="return otpValidate();" method="post">
<table>
<tr>
...
<tr>
 <td><input type="hidden" name="mode" value="validationOTP"></td><td><input type="submit" value="VALIDATE"></td>
 </tr>
 </table> 
 </form>
