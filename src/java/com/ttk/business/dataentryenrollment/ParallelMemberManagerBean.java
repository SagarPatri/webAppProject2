...
import com.ttk.dao.impl.dataentryenrollment.MemberDAOImpl;
...
public class ParallelMemberManagerBean implements ParallelMemberManager{
   ...
   {
       memberDAO = (MemberDAOImpl)this.getEnrollmentDAO("member");
       return memberDAO.cancelMember(alMember);
   ...
   /**
    ...
    public long saveBonus(SumInsuredVO sumInsuredVO,String strPolicyMode,String strPolicyType) throws TTKException{
        memberDAO = (MemberDAOImpl)this.getEnrollmentDAO("member");
        return memberDAO.saveBonus(sumInsuredVO,strPolicyMode,strPolicyType);
    ...
    public int saveMemberPlan(MemberVO memberVO,Long lngPolicyGrpSeqID)throws TTKException
 	{
 	   //System.out.println("inside the save member plan bean");
 		memberDAO = (MemberDAOImpl)this.getEnrollmentDAO("member");
