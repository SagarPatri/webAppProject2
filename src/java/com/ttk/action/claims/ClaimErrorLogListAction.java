...
public class ClaimErrorLogListAction extends TTKAction
{
	private static Logger log = Logger.getLogger(ClaimErrorLogListAction.class);
   ...
   /**
	...
	public ActionForward doViewErrorLog(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			...
			if(!(TTKCommon.checkNull(request.getParameter(strRownum)).equals("")))
			{
	    		...
	    		String claimsSubmissionTypes = (String) frmErrorLogList.get("claimsSubmissionTypes");
	    		System.out.println("=======claimsSubmissionTypes       =  "+claimsSubmissionTypes);
	    		if(claimsSubmissionTypes.equalsIgnoreCase("DTC")){	
	    			System.out.println("=========Value DTC=============");
	    		 strReportId="claimUploadErrorLog";
	    		 parameter = claimUploadErrorLogVO.getReferenceNo();    		   		
	    		jrxmlfile="reports/claims/ClaimUploadErrorLog.jrxml";
	    		}else{
	    			System.out.println("-------------Value DTR----------------------");
	    			 strReportId="claimUploadErrorLog";
		    		 parameter = claimUploadErrorLogVO.getReferenceNo();    		 
    ...
    private ArrayList<Object> populateSearchCriteria(DynaActionForm frmErrorLogList,HttpServletRequest request)
    {
    	...
    	alSearchParams.add("");
    	alSearchParams.add(TTKCommon.checkNull(frmErrorLogList.getString("claimsSubmissionTypes")));
