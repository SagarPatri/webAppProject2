...
<script language="javascript" src="/ttk/scripts/preauth/dashbordassignto.js"></script>
...
//	ArrayList alUserList=(ArrayList)request.getSession().getAttribute("alUserList");
    pageContext.setAttribute("dependentuser",Cache.getCacheObjectForDependentUser("dashborddependentuser",userseqid));
...
<!-- S T A R T : Content/Form Area -->
	<html:form action="/AssignToDashBordPreauthAction.do">
 ...
 <% 
 if((TTKCommon.isAuthorized(request, "Assign") || TTKCommon.isAuthorized(request, "AssignAll"))){	%> 
  ...
  <tr>
    ...
    <logic:match name="strLink"  value="Pre-Authorization">
    	<td valign="top" class="formLabel" id="strLinkIDForPreAuth">Pre-Approval Selected:</td>
 		 <logic:notEmpty name="frmDashbordAssign" property="preAuthSeqID">
    		 <td valign="top" class="textLabelBold"><bean:write name="frmDashbordAssign" property="selectedPreAuthNos"/></td>
 		</logic:notEmpty>
	</logic:match>
 <%--  <td valign="top" class="textLabelBold"><bean:write name="frmAssign" property="selectedPreAuthNos"/></td> --%>
  ...
  <tr>
    ...
    <td><html:select property="doctor" styleClass="selectBox selectBoxMedium" disabled="<%= viewmode %>">
    	<!--<html:option value="">Select from list</html:option>-->
       <%-- <html:options collection="dependentuser" property="cacheId" labelProperty="cacheDesc"/> --%>
  ...
  <tr>
   ...
   <%--  <td class="formLabel">
    <html:textarea  property="remarks" styleClass="textBox textAreaLong" disabled="<%= viewmode %>"/></td> --%>
     <td><html:select property="remarks" styleClass="selectBox selectBoxMedium" disabled="<%= viewmode %>">
