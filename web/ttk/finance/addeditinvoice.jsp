...
<logic:match value="DFL" name="frmInvoiceGeneral"  property="statusTypeID">
	<% viewmode=true; %>
	</logic:match>
</logic:notEmpty>
      ...
      <tr>
       ...
       <%--  <td width="30%">
        	<html:text name="frmInvoiceGeneral" property="fromDate" styleClass="textBox textDate" disabled="true" readonly="true"/> --%>
        	 ...
        	 <td width="30%"><html:text name="frmInvoiceGeneral" onchange="javascript:refreshPolicyNo();" property="fromDate" styleClass="textBox textDate" disabled="<%= viewmode %>" readonly="<%= viewmode %>"/>
          <logic:match name="viewmode" value="false"><A NAME="calEndDate" ID="calEndDate" HREF="#" onClick="javascript:refreshPolicyNo();show_calendar('calEndDate','frmInvoiceGeneral.fromDate',document.frmInvoiceGeneral.fromDate.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar"  width="24" height="17" border="0" align="absmiddle"></a></logic:match>
        	
        	
        </td>
          
        <td width="20%">Invoice To Date:<span class="mandatorySymbol">*</span></td>
        <td width="30%"><html:text name="frmInvoiceGeneral"  onchange="javascript:refreshPolicyNo();" property="toDate" styleClass="textBox textDate" disabled="<%= viewmode %>" readonly="<%= viewmode %>"/>
        ...
        <tr>
	        ...
	        <td width="30%">
		        <html:checkbox name="frmInvoiceGeneral" onclick="javascript:refreshPolicyNo();" property="includeOldYN" value="Y" disabled="<%= viewmode %>"/>
    	   ...
    	   <html:hidden name="frmInvoiceGeneral" property="policySeqID"/>
			...
			<tr>	         
    			<td width="20%" nowrap>Remittance Bank: </td>
        			  	<td width="30%" nowrap class="textLabelBold">
	        				<bean:write name="frmInvoiceGeneral" property="remittanceBank"/>
            			</td>
        			<td width="20%" nowrap>Bank Account : </td>
        				<td width="30%" nowrap class="textLabelBold">
	        				<bean:write name="frmInvoiceGeneral" property="bankAccount"/>
            			</td>      
        	</tr>
       ...
       <%--  <td width="20%" class="formLabel">Status:<span class="mandatorySymbol">*</span></td>
        ...
        <html:select property="statusTypeID" styleId="Status" styleClass="selectBoxMedium selectBoxDisabled" >
         ...
         <td nowrap id="dueDate1" style="display:none " class="formLabel"><span class="mandatoryLabel spanImmediate">Due date :</span><span class="mandatoryLabel spanHalfyear">Half Year Due date 1 :</span><span class="mandatoryLabel spanQuaterly">Qauterly Due date 1 :</span><span class="mandatorySymbol ">*</span><br>
          <html:text name="frmInvoiceGeneral" property="dtdueDate1" styleClass="textBox textDate" disabled="<%= viewmode %>" readonly="<%= viewmode %>"/>
          <A NAME="calDueDate1" ID="calDueDate1" HREF="#" onClick="javascript:show_calendar('calDueDate1','frmInvoiceGeneral.dtdueDate1',document.frmInvoiceGeneral.dtdueDate1.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar"  width="24" height="17" border="0" align="absmiddle"></a>
        </td>
         ...
         <td nowrap id="dueDate2" style="display:none " class="formLabel"><span class="mandatoryLabel spanHalfyear">Half Year Due date 2:</span><span class="mandatoryLabel spanQuaterly">Qauterly Due date 2:</span><span class="mandatorySymbol ">*</span><br>
          <html:text name="frmInvoiceGeneral" property="dtdueDate2" styleClass="textBox textDate" disabled="<%= viewmode %>" readonly="<%= viewmode %>"/>
          <A NAME="calDueDate1" ID="calDueDate2" HREF="#" onClick="javascript:show_calendar('calDueDate2','frmInvoiceGeneral.dtdueDate2',document.frmInvoiceGeneral.dtdueDate2.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar"  width="24" height="17" border="0" align="absmiddle"></a>
        </td>
        
         <td nowrap  id="dueDate3"  style="display:none "class="formLabel">Qauterly Due date 3:<span class="mandatorySymbol">*</span><br>
         <html:text name="frmInvoiceGeneral" property="dtdueDate3" styleClass="textBox textDate" disabled="<%= viewmode %>" readonly="<%= viewmode %>"/>
          <A NAME="calDueDate1" ID="calDueDate3" HREF="#" onClick="javascript:show_calendar('calDueDate3','frmInvoiceGeneral.dtdueDate3',document.frmInvoiceGeneral.dtdueDate3.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar"  width="24" height="17" border="0" align="absmiddle"></a>
        </td>
        
         <td nowrap id="dueDate4" style="display:none " class="formLabel">Qauterly Due date 4:<span class="mandatorySymbol">*</span><br>
          <html:text name="frmInvoiceGeneral" property="dtdueDate4" styleClass="textBox textDate" disabled="<%= viewmode %>" readonly="<%= viewmode %>"/>
          <A NAME="calDueDate1" ID="calDueDate4" HREF="#" onClick="javascript:show_calendar('calDueDate4','frmInvoiceGeneral.dtdueDate4',document.frmInvoiceGeneral.dtdueDate4.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar"  width="24" height="17" border="0" align="absmiddle"></a>
        </td>
    	...
    	<td width="100%" align="center">
			...
			<logic:match name="frmInvoiceGeneral" property="statusTypeID" value="DFL">
				<logic:empty name="frmInvoiceGeneral" property="batchSeqID">
					...
					<button type="button" id="generatebutton" style="display: " name="Button2" accesskey="g" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="onGenerateTPARpt('<bean:write name="frmInvoiceGeneral" property="fromDate"/>','<bean:write name="frmInvoiceGeneral" property="toDate"/>','<bean:write name="frmInvoiceGeneral" property="seqID"/>','<bean:write name="frmInvoiceGeneral" property="policySeqID"/>')"><u>G</u>enerate Invoice</button>&nbsp;
				</logic:notMatch>
				</logic:empty>
			</logic:match>
