...
/**
	...
	*/
     ...
     * Get Network types  
     *//*
    public ArrayList<String[]> getPartnerNetworkTypes(Long lngPtnrSeqId) throws TTKException;
	*/
	 ...
	 * @param partnerDetailVO PartnerDetailVO object which contains the partner details to be added/updated
	 ...
	 * @return PartnerDetailVO object which contains all the hospital details
	 * @exception throws TTKException 
	 */
	 ...
	 * The method also calls other methods on DAO to update the partner status to the database 
