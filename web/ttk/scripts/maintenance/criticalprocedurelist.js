...
{ 
    ...
    if(getCheckedCount('chkopt',document.forms[1])> 0)
	    {
			var msg = confirm("Are you sure you want to Associate the selected Procedure(s)?");
			if(msg)
				{
...
{ 
 ...
 if(getCheckedCount('chkopt',document.forms[1])> 0)
	    {
			var msg = confirm("Are you sure you want to Exclude the selected Critical Procedure(s)?");
			if(msg)
				{
