...
<script language="javascript" src="/ttk/scripts/reports/ibmnewdeletionreportparam.js"></script>
...
<html:form action="/IBMReportsAction.do">
	...
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>New IBMDeletion Reports</td>
		</tr>
	</table>
<%
pageContext.setAttribute("newDeletion",Cache.getCacheObject("newDeletion"));
		...
		<legend>Report Parameters </legend>
			<table border="0" align="center" cellpadding="0" cellspacing="0" class="formContainer">
				<tr>
					...
					<td>
						<html:select property="policySeqID"  styleClass="selectBoxWeblogin selectBoxLargestWeblogin" onchange="javascript:onSelectPolicy();">
				...
				<tr>
				<td nowrap>Status. <span class="mandatorySymbol">*</span></td>
					<td>
						<html:select property="yearID"  styleClass="selectBox selectBoxMedium">
							<html:option value="">Select from list</html:option>
							<html:optionsCollection name="newDeletion"  label="cacheDesc" value="cacheId" />
		    			</html:select>
					</td>
				</tr>
			</table>
	...
	<table align="center" class="buttonsContainer" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100%" align="center">Report Type
				...
				<button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'"	onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGenerateNewDeletionReport();"><u>G</u>enerateReport</button>
				&nbsp;
