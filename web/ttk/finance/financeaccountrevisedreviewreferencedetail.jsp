<%
/**
 * @ (#) financeaccountReviewreferencedetail.jsp.jsp 4th Sep 2018
 * Project      : TTK HealthCare Services
 * File         : financeaccountReviewreferencedetail.jsp.jsp
 * Author       : Deepthi Meesala
 * Company      : RCS
 * Date Created : 4th Sep 2018
 *
 * @author       :
 * Modified by   :
 * Modified date :
...
<script language="javascript" src="/ttk/scripts/finance/financeaccountrevisedreferencedetail.js"></script>
  ...
  <tr>
    ...
    <table align="center" class="formContainer" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td>
        	<html:text property="refDate" styleClass="textBox textDate" maxlength="10" /><A NAME="CalendarObjectRefDate" ID="CalendarObjectRefDate" HREF="#" onClick="javascript:show_calendar('CalendarObjectRefDate','frmCustomerBankAccountList.elements[\'refDate\']',document.frmCustomerBankAccountList.elements['refDate'].value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;"><img src="/ttk/images/CalendarIcon.gif" title="Calendar" alt="Calendar" name="empDate" width="24" height="17" border="0" align="absmiddle"></a>
        </td>
        <td>Reference No.: </td>
        <td>
...
<table align="center" class="buttonsContainer"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" align="center">
	    <button type="button" name="Button" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onUserReviewSave();"><u>S</u>ave</button>&nbsp;
...
<INPUT TYPE="hidden" NAME="Flag" VALUE="Rnw">
