...
public class CashBenefitAction extends TTKAction
{
	private static Logger log = Logger.getLogger( CashBenefitAction.class );

	//Action mapping forwards.
	private static final String strProductCashBenefitList="CashBenefitlist";
	private static final String strPolicyCashBenefitList="policyCashBenefitlist";
	...
	public ActionForward  doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws Exception 
	{
		try
		{
			log.debug("Inside the doDefault method of CashBenefitAction");
			setLinks(request);
			String strTable = "";
			DynaActionForm frmCashBenefitList =(DynaActionForm)form;
			...
			if("Products".equals(strActiveSubLink)){
				strForwardPath=strProductCashBenefitList;
			}//end of if("Products".equals(strActiveSubLink))
			else {
				strForwardPath=strPolicyCashBenefitList;
			}//end of else
			frmCashBenefitList.set("caption",sbfCaption.toString());
			...
			alPlanList = productPolicyConfig.getCashBenefitList(tableData.getSearchData());
			tableData.setData(alPlanList,"search");
			request.getSession().setAttribute("tableData",tableData);
			request.setAttribute("frmCashBenefitList",frmCashBenefitList);
	...
	public ActionForward doBackward(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			...
			ArrayList alPlanList = productPolicyConfig.getCashBenefitList(tableData.getSearchData());
	...
	private ArrayList<Object> populateSearchCriteria(HttpServletRequest request) throws TTKException
	{
		...
		Long lnginsCashBenefitSeqID=TTKCommon.getWebBoardId(request);
		Long lngUserSeqId=TTKCommon.getUserSeqId(request);
		alSearchParams.add(new Long(lnginsCashBenefitSeqID));
		
		String strconvBenefit=TTKCommon.getCashBenefitSeqID(request);
		...
		alSearchParams.add(new String(strconvBenefit));
