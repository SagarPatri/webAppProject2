<%
/** @ (#) viewReSubmissionClaimDetails.jsp
...
<script language="javascript" src="/ttk/scripts/onlineforms/providerLogin/viewReSubmissionClaimDetails.js"></script>
...
<html:form action="/ViewOnlineClaimDetails.do" >
			<!-- S T A R T : Content/Form Area -->
			<!-- <div id="navigateBar">Home > Corporate > Detailed > Claim Details</div> -->
<h4 class="sub_heading">Online Re-Submission Claim Details</h4>
...
<span class="fieldGroupTabHeader"> &nbsp;&nbsp;Claim Details&nbsp;&nbsp;&nbsp;</span><br>
	    <table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0"> <tr> 
	    	<td width="25%" class="formLabel"> Claim No. </td>
	    	<td width="25%"> : <bean:write name="frmOnlineClaimsDetails" property="claimNO"/> </td>
	    	<td> &nbsp; </td>
	    	<td> &nbsp; </td>
	    </tr> <tr>
	    	<td width="25%" class="formLabel"> Batch No. </td>
	    	<td width="25%"> : <bean:write name="frmOnlineClaimsDetails" property="batchNo"/> </td>
	    	<td width="25%" class="formLabel"> Submission Date & Time: </td>
    		<td width="25%"> : <bean:write name="frmOnlineClaimsDetails" property="submissionDt"/> </td>
	    	
	    </tr>  <tr>
	    	<td width="25%" class="formLabel"> Claim Status. </td>
	    	<td width="25%"> : <bean:write name="frmOnlineClaimsDetails" property="status"/> </td>
	    	<td width="25%" class="formLabel"> Decision Date & Time: </td>
	    	<td width="25%"> : <bean:write name="frmOnlineClaimsDetails" property="decisionDt"/> </td>
	...
	<br>
		  ...
		  <table align="center" class="formContainer"  border="0" cellspacing="0" cellpadding="0">
	    	<tr>
	      	...
	      	<tr>
		        <td width="15%" class="formLabel">Provider Contact No</td>
	    	...
	    	<tr>
		        <td width="15%" class="formLabel">Al Koot Id</td>
...
<br>
	...
	<!--  Shortfall Docs E N D S -->
    		...
    		if(claimStatus!=null&(claimStatus.equals("In-Progress")||claimStatus.equals("Required Information"))){
    		%> --%>
    <!-- <a href="#" onClick="javascript:onCommonUploadDocuments('HOS|CLM');">Document Uploads</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		 -->
 <%-- <%}else{ %> --%>
...
<table align="center" class="buttonsContainer"  border="0" cellspacing="0" cellpadding="0">
   	<tr>
        <td width="100%" align="center">
			...
			<button type="button" name="Button" accesskey="g" class="olbtn" onClick="javascript:onGenerateLetter();"><u>G</u>enerate Letter</button>&nbsp;&nbsp;&nbsp; 
		 </td>
   	</tr>
</table>
		<!-- E N D : Buttons -->
