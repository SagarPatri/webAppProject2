...
public class DoctorOpinionAction extends TTKAction
{
	...
	private static final  String strDocOpinion="dataentrydocopinion";
	private static final String strMedicalDetails ="dataentrymedicaldetails";
    ...
    public ActionForward doView(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		...
    		ParallelPreAuthManager preAuthObject=this.getPreAuthManagerObject();
