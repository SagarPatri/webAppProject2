...
function onSelectGroup()
{
	...
	document.forms[1].reportID.value="AccentureRpt";
	document.forms[1].action="/AccentureReportsAction.do";
	document.forms[1].submit();
...
function onGenerateAccentureReport()
{
	...
	var partmeter = "?mode=doGenerateAccentureRpt&parameter="+parameterValue+"&fileName=reports/enrollment/AccentureReport.jrxml&reportID=AccentureRpt&reportType="+reportType
					+"&sFrom="+reportFrom+"&sTo="+reportTo;
	var openPage = "/AccentureReportsAction.do"+partmeter;
