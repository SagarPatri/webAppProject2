 ...
 *
 */
public class PreAuthWebBoardHelper
{
    private static Logger log = Logger.getLogger( PreAuthWebBoardHelper.class );
   ...
   public static String checkWebBoardId(HttpServletRequest request)throws TTKException
   {
       ...
       PreAuthWebBoardHelper.setWebBoardId(request);
