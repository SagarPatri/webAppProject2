...
function onChangeBank(focusid)
{
    ...
    //	document.forms[1].focusID.value=bankState;   
    	...
    	document.forms[1].action="/UpdateEmplEnrollmentAction.do?focusID="+focusid;
    	document.forms[1].submit();
}//end of onChangeBank()
...
function onChangeQatarYN()
{
	...
	document.forms[1].action="/UpdateEmplEnrollmentAction.do";
	document.forms[1].submit();
	
}

function lowerToUpperCase(Obj)
{
	    var str = Obj.value; 
	    var string = str.toUpperCase(); 
	    document.forms[1].micr.value = string;
}
function lowerToUpperCase1(Obj)
{
	    var str = Obj.value; 
	    var string = str.toUpperCase(); 
	    document.forms[1].ifsc.value = string;
}
