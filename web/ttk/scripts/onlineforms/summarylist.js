...
{   document.forms[1].reset();
    ...
    document.forms[1].action = "/OnlineHistoryListAction.do";
...
function edit(rownum)
{
	...
	document.forms[1].action="/OnlineHistoryDetailAction.do";
	document.forms[1].submit();
}// End of edit()
...
{
	if(document.forms[0].tab.value == "Members")
	{
		document.forms[1].mode.value="doClose";
		document.forms[1].action="/OnlineMemberAction.do";
	}
	else if(document.forms[0].tab.value == "Policies")
	{
