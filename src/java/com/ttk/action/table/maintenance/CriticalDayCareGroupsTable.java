...
public class CriticalDayCareGroupsTable extends Table{
	 ...
	 public void setTableProperties()
	    {
	        ...
	        colDescription.setColumnWidth("20%");
	        ...
	        Column colImage2 = new Column("ICD");
	        colImage2.setColumnWidth("20%");
	        colImage2.setIsImage(true);
	        colImage2.setIsImageLink(true);
	        colImage2.setImageName("getCriticalImageName");
	        colImage2.setImageTitle("getCriticalImageTitle");
	        addColumn(colImage2);
			
	        
	        //Setting properties for image Revision History 
	        Column colImage1 = new Column("PCS");
	        colImage1.setColumnWidth("20%");
...
}//end of class CriticalDayCareGroupsTable
