...
<script language="javascript" src="/ttk/scripts/empanelment/searchtariff.js"></script>
...
//ArrayList alProviderCodeSearch	=	(ArrayList)request.getAttribute("alProviderCodeSearch");
...
<!-- 	<button type="button" name="Button" accesskey="u" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onUploadButton()"><u>U</u>pload Tariff</button>
 	...
 	<%}else{%>
 	<button type="button" name="Button" accesskey="u" class="buttons" onMouseout="this.className='buttons'" disabled="disabled" onMouseover="this.className='buttons buttonsHover'" ><u>U</u>pload Tariff</button>
 	<%}%>
 	&nbsp;&nbsp;&nbsp;&nbsp;
 	...
 	&nbsp;&nbsp;&nbsp;&nbsp;
 	<button type="button" name="Button" accesskey="m" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onModifyServiceType()" style="padding-left:0px;" >Service Type Edit/<u>M</u>odify</button>
