...
<%@ page import="java.util.*,com.ttk.common.security.*,com.ttk.dto.menu.Link" %>
...
<%
	...
	pageContext.setAttribute("preauthLogType",Cache.getCacheObject("preauthLogType"));
	pageContext.setAttribute("claimLogType",Cache.getCacheObject("claimLogType"));
	
	if(generalForm !=null)
	{
		switchType=TTKCommon.checkNull((String)generalForm.get("switchType"));
	}
...
<!-- S T A R T : Content/Form Area -->
	...
	<%
	  	...
	  	if((strLink.equals("Empanelment")&& strSubLink.equals("Hospital"))||
	  		...
	  		(strLink.equals("Administration")&& strSubLink.equals("Policies")))
		{
	%>
	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <%
	  	if((strLink.equals("Administration")&& strSubLink.equals("Policies")))
		{
	%>
	    <td align="left" nowrap>Log Type:<br>
		      	<html:select property="logTypeCode" styleClass="selectBox selectBoxMedium" styleId="logTypeId" >
		  	 	  		<html:option value="">Any</html:option>
		  	 	  		<html:option value="TOB">TOB Details</html:option>
	...
	%>
		    <td align="left" nowrap>Log Type:<br>
		      	<html:select property="logTypeCode" styleClass="selectBox selectBoxMedium" styleId="logTypeId" onchange="getTextBox()">
		  	 	  		<html:option value="">Any</html:option>
		          		<html:optionsCollection name="logTypeCode" label="cacheDesc" value="cacheId" />
            	</html:select>
	        </td>
    <%
		...
		if((strLink.equals("Coding")&& strSubLink.equals("PreAuth"))||
    ...
    %>
    		<td align="left" nowrap>Log Type:<br>
    			<html:select property="sLogType" styleClass="selectBox selectBoxMedium" styleId="logTypeId">
		  	 	  		<html:option value="">Any</html:option>
    ...
    <%
    		...
    		if((strLink.equals("Enrollment")&& strSubLink.equals("Corporate Policy") && switchType.equals("ENM"))||
    		   (strLink.equals("Enrollment")&& strSubLink.equals("Corporate Policy") && switchType.equals("END")))
    	{
    %>
    		 <td align="left" nowrap>Log Type:<br>
    			<html:select property="sLogType" styleClass="selectBox selectBoxMedium" styleId="logTypeId">
		  	 	  		<html:option value="ANY">Any</html:option>
		  	 	  		<html:option value="POL">Policy Details</html:option>
		  	 	  		<html:option value="EMP">Employee Details</html:option>
		  	 	  		<html:option value="MEM">Member Details</html:option>
		  	 	  		<html:option value="USR">User Created</html:option>
    	...
    	<%
    		...
    		if((strLink.equals("Claims")&& strSubLink.equals("Processing")))
    	{
    %>
   ...
   <%
    ...
    %>
    			...
    			<html:select property="sLogType" styleClass="selectBox selectBoxMedium" styleId="logTypeId">
		  	 	  		<html:option value="">Any</html:option>
		          		<html:optionsCollection name="preauthLogType" label="cacheDesc" value="cacheId" /> 
            	</html:select>
    		</td>
    <%
    	}// end of if(strLink.equals("Pre-Authorization")&& strSubLink.equals("Processing"))
    ...
    %>
	    ...
	    <td align="left" nowrap>End Date:<br>
		  ...
		  <td align="left" nowrap id="textLabelId">Internal Code:<br>
		  <html:text property="internalCode"  styleClass="textBox textDate" maxlength="10" styleId="textBoxId"/></td>
		  <%} %>
	...
	<html:hidden property="logFlag" name="frmHospitalLog"/>
