...
function onSave()
{
  ...
  if(!JS_SecondSubmit){ 
  	...
  	if(document.forms[0].leftlink.value == 'DataEntryCoding')
  	document.forms[1].action="/DataEntrySaveCodeICDPCSCodingAction.do";
  	else
	document.forms[1].action="/DataEntrySaveICDPCSCodingAction.do";  	
