...
<!-- <div id="navigateBar">Home > Corporate > Detailed > Claim Details</div> -->
	<h4 class="sub_heading">Dashboard</h4>
	...
	<table align="center" class="searchContainer" border="0" cellspacing="3" cellpadding="3">
		...
		<td colspan="5" align="center">Select Pre-Auth/Claims/Batch:<br>
   			<select name="preAuthClm" id="selectType" styleClass="selectBox selectBoxSmall" onChange="displayRequired()" style="">
       			...
       			<option value="BAT" <%if("BAT".equals(preAuthClmObj)) out.print("selected"); %>>--Batch--</option>
   			</select>
       </td>
   	    </tr>
	<tr>
			 <td  width="20%" nowrap>&nbsp;</td>
          	<td style="" id="batchNo" width="20%" nowrap>Batch No<span class="mandatorySymbol">*</span><br>
	            <INPUT TYPE="text" NAME="batchNo"  class="textBox" VALUE="" maxlength="50"> 
            </td>
          	<td style="display:none" id="fromDate" width="20%" nowrap>From Date:<span class="mandatorySymbol">*</span><br>
          	 ...
          	 <td style="display:none" id="toDate" width="20%" nowrap>To Date:<span class="mandatorySymbol">*</span><br>
        	...
        	<a href="#" accesskey="s" onClick="javascript:onDashBoardBatchSearch()" class="search">
	        <img src="/ttk/images/SearchIcon.gif" alt="Search" title="Search" width="16" height="16" border="0" align="absmiddle">&nbsp;<u>S</u>earch
       	 	</a>&nbsp;&nbsp;&nbsp;
       	 	
       	 	<a href="#" accesskey="r" onClick="javascript:onDashBoardBatchRefresh()" class="search">
