...
<script language="javascript" src="/ttk/scripts/dataentrypreauth/enrollmentlist.js"></script>
...
%>
<html:form action="/DataEntryEnrollmentListAction.do">
	...
	<table align="center" class="searchContainer" border="0" cellspacing="0" cellpadding="0">
      <tr>
      	...
      	<td width="21%" nowrap>Enrollment Id:<br>
