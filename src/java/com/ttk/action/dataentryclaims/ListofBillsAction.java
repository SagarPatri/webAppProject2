...
public class ListofBillsAction extends TTKAction {
    ...
    private static final String strBilllist="dataentrybilllist";
    private static final String strbilldetails="dataentrybilldetails";
    ...
    public ActionForward doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
    		log.debug("Inside the doDefault method of DataEntryListofBillsAction");
    		setLinks(request);
    ...
    public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    												HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doSearch method of DataEntryListofBillsAction");
    		setLinks(request);
    ...
    public ActionForward doBackward(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    																HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doBackward method of DataEntryListofBillsAction");
    		setLinks(request);
    		ClaimBillManager billManagerObject=this.getbillManagerObject();
    		TableData  tableData =TTKCommon.getTableData(request);
    ...
    public ActionForward doForward(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    																HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doForward method of DataEntryListofBillsAction");
    		setLinks(request);
    		ClaimBillManager billManagerObject=this.getbillManagerObject();
    		TableData  tableData =TTKCommon.getTableData(request);
    ...
    public ActionForward doInclude(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    											HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doInclude method of DataEntryListofBillsAction");
    		setLinks(request);
    		ClaimBillManager billManagerObject=this.getbillManagerObject();
    		TableData  tableData =TTKCommon.getTableData(request);
    ...
    public ActionForward doExclude(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    														HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doExclude method of DataEntryListofBillsAction");
    		setLinks(request);
    		ClaimBillManager billManagerObject=this.getbillManagerObject();
    		TableData  tableData =TTKCommon.getTableData(request);
    		StringBuffer sbfIncludeExcludeId = new StringBuffer("|");
    ...
    public ActionForward doAdd(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    															HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doAdd method of DataEntryListofBillsAction");
    		setLinks(request);
    		StringBuffer sbfCaption=new StringBuffer();
    ...
    public ActionForward doView(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    									HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doView method of DataEntryListofBillsAction");
    		setLinks(request);
    		StringBuffer sbfCaption=new StringBuffer();
    ...
    public ActionForward doSave(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    													HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doSave method of DataEntryListofBillsAction");
    		setLinks(request);
    		LineItemVO lineItemVO=null;
    		ClaimBillDetailVO claimBillDetailVO=null;
    		ClaimBillManager billManagerObject=this.getbillManagerObject();
    ...
    public ActionForward doReset(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    													HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doReset method of DataEntryListofBillsAction");
    		setLinks(request);
    		StringBuffer sbfCaption=new StringBuffer();
    		LineItemVO lineItemVO=null;
    		ClaimBillDetailVO claimBillDetailVO=null;
    ...
    public ActionForward doClose(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    										HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doClose method of DataEntryListofBillsAction");
    		setLinks(request);
    		TableData  tableData =TTKCommon.getTableData(request);
    		ClaimBillManager billManagerObject=this.getbillManagerObject();
    ...
    public ActionForward doDeleteList(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    														HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doDeleteList method of DataEntryListofBillsAction");
    		setLinks(request);
    		TableData  tableData =TTKCommon.getTableData(request);
    ...
    public ActionForward doViewBillSummary(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    														HttpServletResponse response) throws Exception{
    	try{
    		log.debug("Inside the doViewBillSummary method of DataEntryListofBillsAction");
    		setLinks(request);
    		//go to summary page
