...
<%
/** @ (#) PreapprovalDetailedReport.jsp March 17, 2020
 * Project     : TTK Healthcare Services
 * File        : PreapprovalDetailedReport.jsp
...
<!-- S T A R T : AllReportsList -->
    <fieldset>
    <legend>Pre-approval Detailed Report</legend>
    ...
    <table align="center" class="buttonsContainer" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100%" align="center">Report Type 
				...
				<button type="button" name="Button" accesskey="g" class="buttons" onMouseout="this.className='buttons'"	onMouseover="this.className='buttons buttonsHover'" onClick="javascript:onGenerateDetailedReport();"><u>G</u>enerateReport</button>
				&nbsp;
