 ...
 */
public class OnlineClmSearchHospAction extends TTKAction {

    private static final Logger log = Logger.getLogger( OnlineClmSearchHospAction.class );
    ...
    private static final String strOnlineClaimList="onlineclmlist";
    ...
    public ActionForward doDashBoardData(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			setOnlineLinks(request);
			log.info("Inside the doDashBoardData method of OnlinePatSearchHospAction");
			...
			String batchNo = TTKCommon.checkNull(request.getParameter("batchNo"));
			...
			if("CLM".equals(preAuthClm)){
			 docClaims=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,null,"Claims");
			 request.getSession().removeAttribute("onlinehosphomeclaim");
			 request.getSession().setAttribute("onlinehosphomeclaim",docClaims);
			}//end of if(TTKCommon.getActiveTab(request).equalsIgnoreCase("Claims"))
			else if("PAT".equals(preAuthClm)){
			 docPreauth=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,null,"Preauth");
			 request.getSession().removeAttribute("onlinehosphomepreauth");
			 request.getSession().setAttribute("onlinehosphomepreauth",docPreauth);
			}//end of else if(TTKCommon.getActiveTab(request).equalsIgnoreCase("Pre-Auth"))
			else if("BAT".equals(preAuthClm)){
				 docBatch=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),null,null,batchNo,"Batch");
				 request.getSession().removeAttribute("onlinehosphomebatch");
				 request.getSession().setAttribute("onlinehosphomebatch",docBatch);
				}//end of else if(TTKCommon.getActiveTab(request).equalsIgnoreCase("Pre-Auth"))
			else{
				 docPreauth=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,null,"Preauth");
				 docClaims=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,null,"Claims");
			...
			if("CLM".equals(preAuthClm)){
				 findForward="claimdashboard";
			}
			else if("PAT".equals(preAuthClm)) {
				 findForward="preauthdashboard";
			}
			else if("BAT".equals(preAuthClm)) {
				 findForward="batchdashboard";
			}
			else{
				findForward="preauthdashboard";
			}
    ...
    public ActionForward doDashBoardDataPrev(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			setOnlineLinks(request);
			log.debug("Inside the doDashBoardDataPrev method of OnlineClmSearchHospAction");
			UserSecurityProfile userSecurityProfile = ((UserSecurityProfile)request.getSession().getAttribute("UserSecurityProfile"));
			OnlineAccessManager onlineAccessManagerObject = null;
			String findForward="";
			//TableData tableData=null;	
    ...
    public ActionForward doDashBoardDataNext(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			setOnlineLinks(request);
			log.info("Inside the doDashBoardDataNext method of OnlineClmSearchHospAction");
			UserSecurityProfile userSecurityProfile = ((UserSecurityProfile)request.getSession().getAttribute("UserSecurityProfile"));
			OnlineAccessManager onlineAccessManagerObject = null;
			String findForward="";
			//TableData tableData=null;	
